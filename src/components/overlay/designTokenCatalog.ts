...
export const DESIGN_TOKEN_CATALOG = [
  cssColor("--brand-primary-50", "Primary 50", "palette", "#fefbfa"),
  cssColor("--brand-primary-100", "Primary 100", "palette", "#fcf6f3"),
  cssColor("--brand-primary-200", "Primary 200", "palette", "#f9efe9"),
  cssColor("--brand-primary-300", "Primary 300", "palette", "#f5e5dc"),
  cssColor("--brand-primary-400", "Primary 400", "palette", "#efd4c7"),
  cssColor("--brand-primary-500", "Primary 500", "palette", "#e7c0ac"),
  cssColor("--brand-primary-600", "Primary 600", "palette", "#cba997"),
  cssColor("--brand-primary-700", "Primary 700", "palette", "#ab8e7f"),
  cssColor("--brand-primary-800", "Primary 800", "palette", "#866f64"),
  cssColor("--brand-primary-900", "Primary 900", "palette", "#584941"),
  cssColor("--brand-primary-950", "Primary 950", "palette", "#332a26"),
  cssColor("--brand-secondary-50", "Secondary 50", "palette", "#fafdfc"),
  cssColor("--brand-secondary-100", "Secondary 100", "palette", "#f3faf9"),
  cssColor("--brand-secondary-200", "Secondary 200", "palette", "#e9f6f4"),
  cssColor("--brand-secondary-300", "Secondary 300", "palette", "#dcf1ed"),
  cssColor("--brand-secondary-400", "Secondary 400", "palette", "#c6e9e2"),
  cssColor("--brand-secondary-500", "Secondary 500", "palette", "#abded5"),
  cssColor("--brand-secondary-600", "Secondary 600", "palette", "#96c3bb"),
  cssColor("--brand-secondary-700", "Secondary 700", "palette", "#7fa49e"),
  cssColor("--brand-secondary-800", "Secondary 800", "palette", "#63817c"),
  cssColor("--brand-secondary-900", "Secondary 900", "palette", "#415451"),
  cssColor("--brand-secondary-950", "Secondary 950", "palette", "#26312f"),
  cssColor("--brand-accent-50", "Accent 50", "palette", "#f8f9fd"),
  cssColor("--brand-accent-100", "Accent 100", "palette", "#f0f2fb"),
  cssColor("--brand-accent-200", "Accent 200", "palette", "#e3e6f8"),
  cssColor("--brand-accent-300", "Accent 300", "palette", "#d1d7f4"),
  cssColor("--brand-accent-400", "Accent 400", "palette", "#b5beed"),
  cssColor("--brand-accent-500", "Accent 500", "palette", "#92a0e4"),
  cssColor("--brand-accent-600", "Accent 600", "palette", "#808dc9"),
  cssColor("--brand-accent-700", "Accent 700", "palette", "#6c76a9"),
  cssColor("--brand-accent-800", "Accent 800", "palette", "#555d84"),
  cssColor("--brand-accent-900", "Accent 900", "palette", "#373d57"),
  cssColor("--brand-accent-950", "Accent 950", "palette", "#202332"),
  cssColor("--brand-highlight-50", "Highlight 50", "palette", "#fdfdfc"),
  cssColor("--brand-highlight-100", "Highlight 100", "palette", "#fbfbf9"),
  cssColor("--brand-highlight-200", "Highlight 200", "palette", "#f8f8f3"),
  cssColor("--brand-highlight-300", "Highlight 300", "palette", "#f4f4ec"),
  cssColor("--brand-highlight-400", "Highlight 400", "palette", "#edede0"),
  cssColor("--brand-highlight-500", "Highlight 500", "palette", "#e5e5d1"),
  cssColor("--brand-highlight-600", "Highlight 600", "palette", "#cacab8"),
  cssColor("--brand-highlight-700", "Highlight 700", "palette", "#a9a99b"),
  cssColor("--brand-highlight-800", "Highlight 800", "palette", "#858579"),
  cssColor("--brand-highlight-900", "Highlight 900", "palette", "#57574f"),
  cssColor("--brand-highlight-950", "Highlight 950", "palette", "#32322e"),
  cssColor("--neutral-50", "Neutral 50", "palette", "#fefdfd"),
  cssColor("--neutral-100", "Neutral 100", "palette", "#fdfaf8"),
  cssColor("--neutral-200", "Neutral 200", "palette", "#fbf5f2"),
  cssColor("--neutral-300", "Neutral 300", "palette", "#f8ede8"),
  cssColor("--neutral-400", "Neutral 400", "palette", "#f4e3da"),
  cssColor("--neutral-500", "Neutral 500", "palette", "#65656d"),
  cssColor("--neutral-600", "Neutral 600", "palette", "#4b4a51"),
  cssColor("--neutral-700", "Neutral 700", "palette", "#38363f"),
  cssColor("--neutral-800", "Neutral 800", "palette", "#292b3a"),
  cssColor("--neutral-900", "Neutral 900", "palette", "#1e1d21"),
  cssColor("--neutral-950", "Neutral 950", "palette", "#100f11"),
  cssColor("--white", "White", "palette", "#ffffff"),
  cssColor("--ink-950", "Ink 950", "palette", "#0f0e10"),
  cssColor("--ink-800", "Ink 800", "palette", "#292b3a"),
  cssColor("--ink-600", "Ink 600", "palette", "#4b4a51"),
  cssColor("--ink-500", "Ink 500", "palette", "#65656d"),
  cssColor("--mist-100", "Mist 100", "palette", "#fefcfc"),
  cssColor("--mist-200", "Mist 200", "palette", "#fdfaf8"),
  cssColor("--mist-300", "Mist 300", "palette", "#fbf5f2"),
  cssColor("--green-600", "Green 600", "palette", "#cba997"),
  cssColor("--green-700", "Green 700", "palette", "#ab8e7f"),
  cssColor("--green-100", "Green 100", "palette", "#fcf6f3"),
  cssColor("--blue-600", "Blue 600", "palette", "#96c3bb"),
  cssColor("--blue-100", "Blue 100", "palette", "#f3faf9"),
  cssColor("--amber-500", "Amber 500", "palette", "#d37a18"),
  cssText("--color-bg", "Page background", "semantic-color", "#fefdfd"),
  cssText("--color-surface", "Surface", "semantic-color", "#fefcfc"),
  cssText("--color-surface-raised", "Raised surface", "semantic-color", "#ffffff"),
  cssText("--color-surface-strong", "Strong surface", "semantic-color", "#fdfaf8"),
  cssText("--color-text", "Text", "semantic-color", "#0f0e10"),
  cssText("--color-muted", "Muted text", "semantic-color", "#4b4a51"),
  cssText("--color-border", "Border", "semantic-color", "#fbf5f2"),
  cssText("--color-accent", "Accent", "semantic-color", "#cba997"),
  cssText("--color-accent-hover", "Accent hover", "semantic-color", "#ab8e7f"),
  cssText("--color-accent-soft", "Soft accent", "semantic-color", "#fcf6f3"),
  cssText("--color-accent-border", "Accent border", "semantic-color", "rgba(231, 192, 172, 0.32)"),
  cssText("--color-blue", "Blue", "semantic-color", "#96c3bb"),
  cssText("--color-blue-soft", "Soft blue", "semantic-color", "#f3faf9"),
  cssText("--color-on-accent", "On accent", "semantic-color", "#111416"),
  cssText("--color-highlight", "Highlight", "semantic-color", "#edede0"),
  cssText("--color-highlight-soft", "Soft highlight", "semantic-color", "#fbfbf9"),
  cssText("--color-on-highlight", "On highlight", "semantic-color", "#111416"),
  cssText("--color-warning", "Warning", "semantic-color", "var(--amber-500)"),
  cssText("--color-success", "Success", "semantic-color", "#27a552"),
  cssText("--color-error", "Error", "semantic-color", "#d63035"),
  cssText("--color-info", "Info", "semantic-color", "#356ae6"),
  cssText("--button-primary-bg", "Primary button background", "semantic-color", "#cba997"),
  cssText("--button-primary-hover", "Primary button hover", "semantic-color", "#ab8e7f"),
  cssText("--button-primary-text", "Primary button text", "semantic-color", "#111416"),
  cssText("--button-secondary-bg", "Secondary button background", "semantic-color", "#fafdfc"),
  cssText("--button-secondary-hover", "Secondary button hover", "semantic-color", "#f3faf9"),
  cssText("--button-secondary-text", "Secondary button text", "semantic-color", "#111416"),
  cssText("--button-secondary-border", "Secondary button border", "semantic-color", "#e9f6f4"),
  cssText("--link-color", "Link", "semantic-color", "#111416"),
  cssText("--link-hover", "Link hover", "semantic-color", "#866f64"),
  cssText("--focus-ring", "Focus ring", "semantic-color", "#efd4c7"),
  cssText("--gradient-hero-start", "Hero gradient start", "semantic-color", "#cba997"),
  cssText("--gradient-hero-end", "Hero gradient end", "semantic-color", "#abded5"),
  cssText("--gradient-hero-accent", "Hero gradient accent", "semantic-color", "#808dc9"),
  cssColor("--chart-1", "Chart 1", "palette", "#cba997"),
  cssColor("--chart-2", "Chart 2", "palette", "#96c3bb"),
  cssColor("--chart-3", "Chart 3", "palette", "#808dc9"),
  cssColor("--chart-4", "Chart 4", "palette", "#e5e5d1"),
  cssText("--badge-brand-bg", "Brand badge background", "semantic-color", "#fcf6f3"),
  cssText("--badge-brand-text", "Brand badge text", "semantic-color", "#ab8e7f"),
  cssText("--badge-brand-border", "Brand badge border", "semantic-color", "#f9efe9"),
  cssText("--badge-highlight-bg", "Highlight badge background", "semantic-color", "#fbfbf9"),
  cssText("--badge-highlight-text", "Highlight badge text", "semantic-color", "#111416"),
  cssText("--badge-highlight-border", "Highlight badge border", "semantic-color", "#f8f8f3"),
  cssText("--dark-color-bg", "Dark page background", "semantic-color", "#100f11"),
  cssText("--dark-color-surface", "Dark surface", "semantic-color", "#211d1d"),
  cssText("--dark-color-text", "Dark text", "semantic-color", "#fefdfd"),
  cssText("--dark-color-border", "Dark border", "semantic-color", "rgba(245, 229, 220, 0.22)"),
  cssText("--color-nav-bg", "Navigation background", "semantic-color", "rgba(255, 255, 255, 0.9)"),
  cssText("--color-footer-muted", "Footer muted text", "semantic-color", "rgba(254, 253, 253, 0.76)"),
  ...
  cssText("--section-padding-x", "Section horizontal padding", "layout", "clamp(1rem, 3.84vw, 2.88rem)"),
  cssText("--section-padding-y-sm", "Small section padding", "layout", "3.24rem"),
  cssText("--section-padding-y-md", "Medium section padding", "layout", "5.4rem"),
  cssText("--section-padding-y-lg", "Large section padding", "layout", "6.48rem"),
  ...
  cssText("--content-readable-max", "Readable content max", "layout", "39rem"),
  cssText(
  ...
  cssNumber("--hero-description-max-width", "Hero description max width", "layout", 39, contentRemRange),
  cssNumber("--footer-copy-max-width", "Footer copy max width", "layout", 27, contentRemRange),
  ...
  cssNumber("--button-font-weight", "Button font weight", "component-size", 660, fontWeightRange),
  ...
  cssNumber("--badge-font-weight", "Badge font weight", "component-size", 660, fontWeightRange),
  cssText("--card-padding", "Card padding", "component-size", "1.62rem"),
  ...
  cssNumber("--faq-trigger-min-height", "FAQ trigger min height", "component-size", 4.86, componentRemRange),
  cssNumber("--radius-sm", "Small radius", "radii", 3, radiusRange),
  cssNumber("--radius-md", "Medium radius", "radii", 4.5, radiusRange),
  cssNumber("--radius-lg", "Large radius", "radii", 6, radiusRange),
  ...
  cssText("--shadow-soft", "Soft shadow", "elevation", "0 20px 60px rgba(16, 15, 17, 0.08)"),
  cssText("--shadow-raised", "Raised shadow", "elevation", "0 32px 100px rgba(16, 15, 17, 0.12)"),
  cssText("--shadow-brand", "Brand shadow", "elevation", "0 28px 84px rgba(203, 169, 151, 0.18)"),
  ...
  cssText(
    "--font-family-heading",
    "Heading font family",
    "typography", "\"Cormorant Garamond\", Georgia, \"Times New Roman\", serif",
  ),
  cssText(
    "--font-family-body",
    "Body font family",
  ...
  cssNumber("--font-size-display", "Display font size", "typography", 6.6738, fontRemRange),
  cssNumber("--font-size-h1", "H1 font size", "typography", 4.0896, fontRemRange),
  cssNumber("--font-size-h2", "H2 font size", "typography", 3.2578, fontRemRange),
  cssNumber("--font-size-h3", "H3 font size", "typography", 2.1244, fontRemRange),
  cssNumber("--font-size-h4", "H4 font size", "typography", 1.545, fontRemRange),
  ...
  cssNumber("--line-height-display", "Display line height", "typography", 0.943, lineHeightRange),
  cssNumber("--line-height-h1", "H1 line height", "typography", 1, lineHeightRange),
  cssNumber("--line-height-h2", "H2 line height", "typography", 1.042, lineHeightRange),
  cssNumber("--line-height-h3", "H3 line height", "typography", 1.132, lineHeightRange),
  cssNumber("--line-height-h4", "H4 line height", "typography", 1.319, lineHeightRange),
  ...
  cssNumber("--line-height-eyebrow", "Eyebrow line height", "typography", 1.591, lineHeightRange),
  cssNumber("--font-weight-heading", "Heading font weight", "typography", 640, fontWeightRange),
  cssNumber("--font-weight-body", "Body font weight", "typography", 380, fontWeightRange),
  cssNumber("--font-weight-strong", "Strong font weight", "typography", 680, fontWeightRange),
  cssNumber("--font-weight-label", "Label font weight", "typography", 700, fontWeightRange),
  cssNumber("--letter-spacing-heading", "Heading letter spacing", "typography", -0.015, {
    min: -0.1,
    max: 0.2,
    step: 0.001,
    unit: "em",
  }),
  cssNumber("--letter-spacing-eyebrow", "Eyebrow letter spacing", "typography", 0.026, {
    min: -0.1,
    max: 0.2,
    step: 0.001,
    unit: "em",
