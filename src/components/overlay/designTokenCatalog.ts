...
export const DESIGN_TOKEN_CATALOG = [
  cssColor("--brand-primary-50", "Primary 50", "palette", "#f8fef4"),
  cssColor("--brand-primary-100", "Primary 100", "palette", "#eefce6"),
  cssColor("--brand-primary-200", "Primary 200", "palette", "#e0f9d0"),
  cssColor("--brand-primary-300", "Primary 300", "palette", "#cdf6b4"),
  cssColor("--brand-primary-400", "Primary 400", "palette", "#aef085"),
  cssColor("--brand-primary-500", "Primary 500", "palette", "#88e94c"),
  cssColor("--brand-primary-600", "Primary 600", "palette", "#78cd43"),
  cssColor("--brand-primary-700", "Primary 700", "palette", "#65ac38"),
  cssColor("--brand-primary-800", "Primary 800", "palette", "#4f872c"),
  cssColor("--brand-primary-900", "Primary 900", "palette", "#34591d"),
  cssColor("--brand-primary-950", "Primary 950", "palette", "#1e3311"),
  cssColor("--brand-secondary-50", "Secondary 50", "palette", "#f4fef7"),
  cssColor("--brand-secondary-100", "Secondary 100", "palette", "#e5fcec"),
  cssColor("--brand-secondary-200", "Secondary 200", "palette", "#cffadc"),
  cssColor("--brand-secondary-300", "Secondary 300", "palette", "#b1f6c7"),
  cssColor("--brand-secondary-400", "Secondary 400", "palette", "#81f1a5"),
  cssColor("--brand-secondary-500", "Secondary 500", "palette", "#45ea7a"),
  cssColor("--brand-secondary-600", "Secondary 600", "palette", "#3dce6b"),
  cssColor("--brand-secondary-700", "Secondary 700", "palette", "#33ad5a"),
  cssColor("--brand-secondary-800", "Secondary 800", "palette", "#288847"),
  cssColor("--brand-secondary-900", "Secondary 900", "palette", "#1a592e"),
  cssColor("--brand-secondary-950", "Secondary 950", "palette", "#0f331b"),
  cssColor("--brand-accent-50", "Accent 50", "palette", "#fbf5fe"),
  cssColor("--brand-accent-100", "Accent 100", "palette", "#f5e9fd"),
  cssColor("--brand-accent-200", "Accent 200", "palette", "#edd5fb"),
  cssColor("--brand-accent-300", "Accent 300", "palette", "#e2bcf9"),
  cssColor("--brand-accent-400", "Accent 400", "palette", "#cf92f5"),
  cssColor("--brand-accent-500", "Accent 500", "palette", "#b95ff0"),
  cssColor("--brand-accent-600", "Accent 600", "palette", "#a354d3"),
  cssColor("--brand-accent-700", "Accent 700", "palette", "#8946b2"),
  cssColor("--brand-accent-800", "Accent 800", "palette", "#6b378b"),
  cssColor("--brand-accent-900", "Accent 900", "palette", "#46245b"),
  cssColor("--brand-accent-950", "Accent 950", "palette", "#291535"),
  cssColor("--brand-highlight-50", "Highlight 50", "palette", "#fefcfe"),
  cssColor("--brand-highlight-100", "Highlight 100", "palette", "#fdf9fc"),
  cssColor("--brand-highlight-200", "Highlight 200", "palette", "#fbf4f9"),
  cssColor("--brand-highlight-300", "Highlight 300", "palette", "#f9edf5"),
  cssColor("--brand-highlight-400", "Highlight 400", "palette", "#f5e1ef"),
  cssColor("--brand-highlight-500", "Highlight 500", "palette", "#f1d3e8"),
  cssColor("--brand-highlight-600", "Highlight 600", "palette", "#d4bacc"),
  cssColor("--brand-highlight-700", "Highlight 700", "palette", "#b29cac"),
  cssColor("--brand-highlight-800", "Highlight 800", "palette", "#8c7a87"),
  cssColor("--brand-highlight-900", "Highlight 900", "palette", "#5c5058"),
  cssColor("--brand-highlight-950", "Highlight 950", "palette", "#352e33"),
  cssColor("--neutral-50", "Neutral 50", "palette", "#fbfefa"),
  cssColor("--neutral-100", "Neutral 100", "palette", "#f5fdf1"),
  cssColor("--neutral-200", "Neutral 200", "palette", "#ecfbe2"),
  cssColor("--neutral-300", "Neutral 300", "palette", "#def9cd"),
  cssColor("--neutral-400", "Neutral 400", "palette", "#cbf5b0"),
  cssColor("--neutral-500", "Neutral 500", "palette", "#4b7052"),
  cssColor("--neutral-600", "Neutral 600", "palette", "#36533c"),
  cssColor("--neutral-700", "Neutral 700", "palette", "#263e2e"),
  cssColor("--neutral-800", "Neutral 800", "palette", "#1e302e"),
  cssColor("--neutral-900", "Neutral 900", "palette", "#152118"),
  cssColor("--neutral-950", "Neutral 950", "palette", "#0a120b"),
  cssColor("--white", "White", "palette", "#ffffff"),
  cssColor("--ink-950", "Ink 950", "palette", "#09110a"),
  cssColor("--ink-800", "Ink 800", "palette", "#1e302e"),
  cssColor("--ink-600", "Ink 600", "palette", "#36533c"),
  cssColor("--ink-500", "Ink 500", "palette", "#4b7052"),
  cssColor("--mist-100", "Mist 100", "palette", "#fafef8"),
  cssColor("--mist-200", "Mist 200", "palette", "#f5fdf1"),
  cssColor("--mist-300", "Mist 300", "palette", "#ecfbe2"),
  cssColor("--green-600", "Green 600", "palette", "#78cd43"),
  cssColor("--green-700", "Green 700", "palette", "#65ac38"),
  cssColor("--green-100", "Green 100", "palette", "#eefce6"),
  cssColor("--blue-600", "Blue 600", "palette", "#3dce6b"),
  cssColor("--blue-100", "Blue 100", "palette", "#e5fcec"),
  cssColor("--amber-500", "Amber 500", "palette", "#d67519"),
  cssText("--color-bg", "Page background", "semantic-color", "#fbfefa"),
  cssText("--color-surface", "Surface", "semantic-color", "#fafef8"),
  cssText("--color-surface-raised", "Raised surface", "semantic-color", "#ffffff"),
  cssText("--color-surface-strong", "Strong surface", "semantic-color", "#f5fdf1"),
  cssText("--color-text", "Text", "semantic-color", "#09110a"),
  cssText("--color-muted", "Muted text", "semantic-color", "#36533c"),
  cssText("--color-section-text", "Section text", "semantic-color", "#09110a"),
  cssText("--color-section-muted", "Section muted text", "semantic-color", "#36533c"),
  cssText("--color-surface-text", "Surface text", "semantic-color", "#09110a"),
  cssText("--color-surface-muted", "Surface muted text", "semantic-color", "#36533c"),
  cssText("--color-card-text", "Card text", "semantic-color", "#09110a"),
  cssText("--color-card-muted", "Card muted text", "semantic-color", "#36533c"),
  ...
  cssText("--color-inverted-text", "Inverted section text", "semantic-color", "#fbfefa"),
  cssText("--color-inverted-muted", "Inverted muted text", "semantic-color", "#ffffff"),
  cssText("--color-border", "Border", "semantic-color", "#ecfbe2"),
  cssText("--color-accent", "Accent", "semantic-color", "#78cd43"),
  cssText("--color-accent-hover", "Accent hover", "semantic-color", "#65ac38"),
  cssText("--color-accent-soft", "Soft accent", "semantic-color", "#eefce6"),
  cssText("--color-accent-border", "Accent border", "semantic-color", "rgba(136, 233, 76, 0.32)"),
  cssText("--color-blue", "Blue", "semantic-color", "#3dce6b"),
  cssText("--color-blue-soft", "Soft blue", "semantic-color", "#e5fcec"),
  cssText("--color-on-accent", "On accent", "semantic-color", "#111416"),
  cssText("--color-highlight", "Highlight", "semantic-color", "#f5e1ef"),
  cssText("--color-highlight-soft", "Soft highlight", "semantic-color", "#fdf9fc"),
  cssText("--color-on-highlight", "On highlight", "semantic-color", "#111416"),
  cssText("--color-warning", "Warning", "semantic-color", "var(--amber-500)"),
  cssText("--color-success", "Success", "semantic-color", "#1fa94a"),
  cssText("--color-error", "Error", "semantic-color", "#d92b36"),
  cssText("--color-info", "Info", "semantic-color", "#2d6ede"),
  cssText("--button-primary-bg", "Primary button background", "semantic-color", "#78cd43"),
  cssText("--button-primary-hover", "Primary button hover", "semantic-color", "#65ac38"),
  cssText("--button-primary-text", "Primary button text", "semantic-color", "#111416"),
  cssText("--button-secondary-bg", "Secondary button background", "semantic-color", "#f4fef7"),
  cssText("--button-secondary-hover", "Secondary button hover", "semantic-color", "#e5fcec"),
  cssText("--button-secondary-text", "Secondary button text", "semantic-color", "#111416"),
  cssText("--button-secondary-border", "Secondary button border", "semantic-color", "#cffadc"),
  cssText("--link-color", "Link", "semantic-color", "#111416"),
  cssText("--link-hover", "Link hover", "semantic-color", "#111416"),
  cssText("--focus-ring", "Focus ring", "semantic-color", "#aef085"),
  cssText("--gradient-hero-start", "Hero gradient start", "semantic-color", "#78cd43"),
  cssText("--gradient-hero-end", "Hero gradient end", "semantic-color", "#45ea7a"),
  cssText("--gradient-hero-accent", "Hero gradient accent", "semantic-color", "#a354d3"),
  cssColor("--chart-1", "Chart 1", "palette", "#78cd43"),
  cssColor("--chart-2", "Chart 2", "palette", "#3dce6b"),
  cssColor("--chart-3", "Chart 3", "palette", "#a354d3"),
  cssColor("--chart-4", "Chart 4", "palette", "#f1d3e8"),
  cssText("--badge-brand-bg", "Brand badge background", "semantic-color", "#eefce6"),
  cssText("--badge-brand-text", "Brand badge text", "semantic-color", "#65ac38"),
  cssText("--badge-brand-border", "Brand badge border", "semantic-color", "#e0f9d0"),
  cssText("--badge-highlight-bg", "Highlight badge background", "semantic-color", "#fdf9fc"),
  cssText("--badge-highlight-text", "Highlight badge text", "semantic-color", "#111416"),
  cssText("--badge-highlight-border", "Highlight badge border", "semantic-color", "#fbf4f9"),
  cssText("--dark-color-bg", "Dark page background", "semantic-color", "#0a120b"),
  cssText("--dark-color-surface", "Dark surface", "semantic-color", "#14230f"),
  cssText("--dark-color-text", "Dark text", "semantic-color", "#fbfefa"),
  cssText("--dark-color-border", "Dark border", "semantic-color", "rgba(205, 246, 180, 0.22)"),
  cssText("--color-nav-bg", "Navigation background", "semantic-color", "#ffffff"),
  cssText("--color-nav-border", "Navigation border", "semantic-color", "#ecfbe2"),
  cssText("--color-nav-lockup-logo", "Navigation lockup logo", "semantic-color", "#111416"),
  cssText("--color-nav-link", "Navigation link", "semantic-color", "#36533c"),
  cssText("--color-nav-link-hover", "Navigation link hover", "semantic-color", "#09110a"),
  cssText("--color-marquee-logo", "Marquee logo", "semantic-color", "#36533c"),
  cssText("--color-footer-bg", "Footer background", "semantic-color", "#09110a"),
  cssText("--color-footer-border", "Footer border", "semantic-color", "#ecfbe2"),
  cssText("--color-footer-text", "Footer text", "semantic-color", "#ffffff"),
  cssText("--color-footer-link", "Footer link", "semantic-color", "#e0f9d0"),
  cssText("--color-footer-link-hover", "Footer link hover", "semantic-color", "#f8fef4"),
  cssText("--color-footer-lockup-logo", "Footer lockup logo", "semantic-color", "#88e94c"),
  ...
  cssNumber("--hero-grid-text-fr", "Hero grid text fraction", "layout", 0.84, fractionRange),
  cssNumber("--hero-grid-visual-fr", "Hero grid visual fraction", "layout", 1.16, fractionRange),
  ...
  cssNumber("--footer-copy-max-width", "Footer copy max width", "layout", 26, contentRemRange),
  ...
  cssNumber("--button-font-size", "Button font size", "component-size", 0.8694, fontRemRange),
  ...
  cssNumber("--lockup-logo-size", "Lockup logo size", "component-size", 41, lockupPxRange),
  cssText(
  ...
  cssNumber("--lockup-wordmark-size", "Lockup wordmark size", "component-size", 20, lockupPxRange),
  cssNumber("--lockup-wordmark-tracking", "Lockup wordmark tracking", "component-size", 2.1, {
    min: -2,
    max: 10,
    step: 0.1,
    unit: "px",
  ...
  cssNumber("--navbar-link-font-size", "Navbar link font size", "component-size", 0.8694, fontRemRange),
  cssText(
  ...
  cssNumber("--demo-canvas-left-fr", "Demo canvas left fraction", "component-size", 1.12, fractionRange),
  cssNumber("--demo-canvas-min-column", "Demo canvas min column", "component-size", 16, componentRemRange),
  cssNumber("--demo-canvas-right-fr", "Demo canvas right fraction", "component-size", 0.88, fractionRange),
  cssNumber("--demo-layer-font-size", "Demo layer font size", "component-size", 0.8694, fontRemRange),
  ...
  cssNumber("--radius-sm", "Small radius", "radii", 5, radiusRange),
  cssNumber("--radius-md", "Medium radius", "radii", 7.5, radiusRange),
  cssNumber("--radius-lg", "Large radius", "radii", 10, radiusRange),
  ...
  cssText("--shadow-soft", "Soft shadow", "elevation", "0 20px 60px rgba(10, 18, 11, 0.08)"),
  cssText("--shadow-raised", "Raised shadow", "elevation", "0 32px 100px rgba(10, 18, 11, 0.12)"),
  cssText("--shadow-brand", "Brand shadow", "elevation", "0 28px 84px rgba(120, 205, 67, 0.18)"),
  ...
  cssText(
    "--font-family-body",
    "Body font family",
    "typography", "\"Commit Mono\", \"SFMono-Regular\", \"Cascadia Code\", monospace",
  ),
  cssText(
    "--font-family-button",
    "Button font family",
    "typography",
    "\"Commit Mono\", \"SFMono-Regular\", \"Cascadia Code\", monospace",
  ),
  cssNumber("--font-size-display", "Display font size", "typography", 6.2525, fontRemRange),
  cssNumber("--font-size-h1", "H1 font size", "typography", 3.858, fontRemRange),
  cssNumber("--font-size-h2", "H2 font size", "typography", 3.0733, fontRemRange),
  cssNumber("--font-size-h3", "H3 font size", "typography", 2.0681, fontRemRange),
  cssNumber("--font-size-h4", "H4 font size", "typography", 1.5041, fontRemRange),
  cssNumber("--font-size-body-lg", "Large body font size", "typography", 1.242, fontRemRange),
  cssNumber("--font-size-body", "Body font size", "typography", 0.9936, fontRemRange),
  cssNumber("--font-size-caption", "Caption font size", "typography", 0.7452, {
    ...fontRemRange,
    step: 0.001,
  }),
  cssNumber("--font-size-eyebrow", "Eyebrow font size", "typography", 0.621, fontRemRange),
  cssNumber("--line-height-root", "Root line height", "typography", 1.492, lineHeightRange),
  cssNumber("--line-height-display", "Display line height", "typography", 0.96, lineHeightRange),
  cssNumber("--line-height-h1", "H1 line height", "typography", 1.01, lineHeightRange),
  cssNumber("--line-height-h2", "H2 line height", "typography", 1.05, lineHeightRange),
  cssNumber("--line-height-h3", "H3 line height", "typography", 1.135, lineHeightRange),
  cssNumber("--line-height-h4", "H4 line height", "typography", 1.321, lineHeightRange),
  cssNumber("--line-height-body-lg", "Large body line height", "typography", 1.587, lineHeightRange),
  cssNumber("--line-height-body", "Body line height", "typography", 1.489, lineHeightRange),
  cssNumber("--line-height-caption", "Caption line height", "typography", 1.494, lineHeightRange),
  cssNumber("--line-height-eyebrow", "Eyebrow line height", "typography", 1.592, lineHeightRange),
  ...
  cssNumber("--letter-spacing-heading", "Heading letter spacing", "typography", -0.026, {
    min: -0.1,
    max: 0.2,
    step: 0.001,
    unit: "em",
  }),
  cssNumber("--letter-spacing-eyebrow", "Eyebrow letter spacing", "typography", 0.007, {
    min: -0.1,
    max: 0.2,
    step: 0.001,
    unit: "em",
