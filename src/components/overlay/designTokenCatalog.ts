...
export const DESIGN_TOKEN_CATALOG = [
  cssColor("--brand-primary-50", "Primary 50", "palette", "#f3faf6"),
  cssColor("--brand-primary-100", "Primary 100", "palette", "#e3f3ea"),
  cssColor("--brand-primary-200", "Primary 200", "palette", "#cbe9d8"),
  cssColor("--brand-primary-300", "Primary 300", "palette", "#abdcc0"),
  cssColor("--brand-primary-400", "Primary 400", "palette", "#78c799"),
  cssColor("--brand-primary-500", "Primary 500", "palette", "#38ac69"),
  cssColor("--brand-primary-600", "Primary 600", "palette", "#31975c"),
  cssColor("--brand-primary-700", "Primary 700", "palette", "#297f4e"),
  cssColor("--brand-primary-800", "Primary 800", "palette", "#20643d"),
  cssColor("--brand-primary-900", "Primary 900", "palette", "#154128"),
  cssColor("--brand-primary-950", "Primary 950", "palette", "#0c2617"),
  cssColor("--brand-secondary-50", "Secondary 50", "palette", "#f4f6fa"),
  cssColor("--brand-secondary-100", "Secondary 100", "palette", "#e4eaf3"),
  cssColor("--brand-secondary-200", "Secondary 200", "palette", "#ced8e8"),
  cssColor("--brand-secondary-300", "Secondary 300", "palette", "#afc0da"),
  cssColor("--brand-secondary-400", "Secondary 400", "palette", "#7e9ac2"),
  cssColor("--brand-secondary-500", "Secondary 500", "palette", "#416aa6"),
  cssColor("--brand-secondary-600", "Secondary 600", "palette", "#395d92"),
  cssColor("--brand-secondary-700", "Secondary 700", "palette", "#304e7b"),
  cssColor("--brand-secondary-800", "Secondary 800", "palette", "#263d60"),
  cssColor("--brand-secondary-900", "Secondary 900", "palette", "#19283f"),
  cssColor("--brand-secondary-950", "Secondary 950", "palette", "#0e1725"),
  cssColor("--brand-accent-50", "Accent 50", "palette", "#f9f3f5"),
  cssColor("--brand-accent-100", "Accent 100", "palette", "#f2e2e9"),
  cssColor("--brand-accent-200", "Accent 200", "palette", "#e7c9d6"),
  cssColor("--brand-accent-300", "Accent 300", "palette", "#d8a8bc"),
  cssColor("--brand-accent-400", "Accent 400", "palette", "#c07393"),
  cssColor("--brand-accent-500", "Accent 500", "palette", "#a33160"),
  cssColor("--brand-accent-600", "Accent 600", "palette", "#8f2b54"),
  cssColor("--brand-accent-700", "Accent 700", "palette", "#792447"),
  cssColor("--brand-accent-800", "Accent 800", "palette", "#5f1c38"),
  cssColor("--brand-accent-900", "Accent 900", "palette", "#3e1324"),
  cssColor("--brand-accent-950", "Accent 950", "palette", "#240b15"),
  cssColor("--brand-highlight-50", "Highlight 50", "palette", "#fcfcfa"),
  cssColor("--brand-highlight-100", "Highlight 100", "palette", "#f8f9f3"),
  cssColor("--brand-highlight-200", "Highlight 200", "palette", "#f2f4e9"),
  cssColor("--brand-highlight-300", "Highlight 300", "palette", "#eaeddc"),
  cssColor("--brand-highlight-400", "Highlight 400", "palette", "#dce2c7"),
  cssColor("--brand-highlight-500", "Highlight 500", "palette", "#ccd4ac"),
  cssColor("--brand-highlight-600", "Highlight 600", "palette", "#b4bb97"),
  cssColor("--brand-highlight-700", "Highlight 700", "palette", "#979d7f"),
  cssColor("--brand-highlight-800", "Highlight 800", "palette", "#767b64"),
  cssColor("--brand-highlight-900", "Highlight 900", "palette", "#4e5141"),
  cssColor("--brand-highlight-950", "Highlight 950", "palette", "#2d2f26"),
  cssColor("--neutral-50", "Neutral 50", "palette", "#f9fdfb"),
  cssColor("--neutral-100", "Neutral 100", "palette", "#eff8f3"),
  cssColor("--neutral-200", "Neutral 200", "palette", "#dff2e7"),
  cssColor("--neutral-300", "Neutral 300", "palette", "#c7e8d5"),
  cssColor("--neutral-400", "Neutral 400", "palette", "#a7dabd"),
  cssColor("--neutral-500", "Neutral 500", "palette", "#345f5b"),
  cssColor("--neutral-600", "Neutral 600", "palette", "#254642"),
  cssColor("--neutral-700", "Neutral 700", "palette", "#183333"),
  cssColor("--neutral-800", "Neutral 800", "palette", "#142932"),
  cssColor("--neutral-900", "Neutral 900", "palette", "#0d1b1b"),
  cssColor("--neutral-950", "Neutral 950", "palette", "#050e0d"),
  cssColor("--white", "White", "palette", "#ffffff"),
  cssColor("--ink-950", "Ink 950", "palette", "#050d0c"),
  cssColor("--ink-800", "Ink 800", "palette", "#142932"),
  cssColor("--ink-600", "Ink 600", "palette", "#254642"),
  cssColor("--ink-500", "Ink 500", "palette", "#345f5b"),
  cssColor("--mist-100", "Mist 100", "palette", "#f7fcfa"),
  cssColor("--mist-200", "Mist 200", "palette", "#eff8f3"),
  cssColor("--mist-300", "Mist 300", "palette", "#dff2e7"),
  cssColor("--green-600", "Green 600", "palette", "#31975c"),
  cssColor("--green-700", "Green 700", "palette", "#297f4e"),
  cssColor("--green-100", "Green 100", "palette", "#e3f3ea"),
  cssColor("--blue-600", "Blue 600", "palette", "#395d92"),
  cssColor("--blue-100", "Blue 100", "palette", "#e4eaf3"),
  cssColor("--amber-500", "Amber 500", "palette", "#d5710d"),
  cssText("--color-bg", "Page background", "semantic-color", "#f9fdfb"),
  cssText("--color-surface", "Surface", "semantic-color", "#f7fcfa"),
  cssText("--color-surface-raised", "Raised surface", "semantic-color", "#ffffff"),
  cssText("--color-surface-strong", "Strong surface", "semantic-color", "#eff8f3"),
  cssText("--color-text", "Text", "semantic-color", "#050d0c"),
  cssText("--color-muted", "Muted text", "semantic-color", "#254642"),
  cssText("--color-border", "Border", "semantic-color", "#dff2e7"),
  cssText("--color-accent", "Accent", "semantic-color", "#31975c"),
  cssText("--color-accent-hover", "Accent hover", "semantic-color", "#297f4e"),
  cssText("--color-accent-soft", "Soft accent", "semantic-color", "#e3f3ea"),
  cssText("--color-accent-border", "Accent border", "semantic-color", "rgba(56, 172, 105, 0.32)"),
  cssText("--color-blue", "Blue", "semantic-color", "#395d92"),
  cssText("--color-blue-soft", "Soft blue", "semantic-color", "#e4eaf3"),
  cssText("--color-on-accent", "On accent", "semantic-color", "#111416"),
  cssText("--color-highlight", "Highlight", "semantic-color", "#dce2c7"),
  cssText("--color-highlight-soft", "Soft highlight", "semantic-color", "#f8f9f3"),
  cssText("--color-on-highlight", "On highlight", "semantic-color", "#111416"),
  cssText("--color-warning", "Warning", "semantic-color", "var(--amber-500)"),
  cssText("--color-success", "Success", "semantic-color", "#19a44c"),
  cssText("--color-error", "Error", "semantic-color", "#d7272b"),
  cssText("--color-info", "Info", "semantic-color", "#2769e1"),
  cssText("--button-primary-bg", "Primary button background", "semantic-color", "#31975c"),
  cssText("--button-primary-hover", "Primary button hover", "semantic-color", "#297f4e"),
  cssText("--button-primary-text", "Primary button text", "semantic-color", "#111416"),
  cssText("--button-secondary-bg", "Secondary button background", "semantic-color", "#f4f6fa"),
  cssText("--button-secondary-hover", "Secondary button hover", "semantic-color", "#e4eaf3"),
  cssText("--button-secondary-text", "Secondary button text", "semantic-color", "#263d60"),
  cssText("--button-secondary-border", "Secondary button border", "semantic-color", "#ced8e8"),
  cssText("--link-color", "Link", "semantic-color", "#297f4e"),
  cssText("--link-hover", "Link hover", "semantic-color", "#20643d"),
  cssText("--focus-ring", "Focus ring", "semantic-color", "#78c799"),
  cssText("--gradient-hero-start", "Hero gradient start", "semantic-color", "#31975c"),
  cssText("--gradient-hero-end", "Hero gradient end", "semantic-color", "#416aa6"),
  cssText("--gradient-hero-accent", "Hero gradient accent", "semantic-color", "#8f2b54"),
  cssColor("--chart-1", "Chart 1", "palette", "#31975c"),
  cssColor("--chart-2", "Chart 2", "palette", "#395d92"),
  cssColor("--chart-3", "Chart 3", "palette", "#8f2b54"),
  cssColor("--chart-4", "Chart 4", "palette", "#ccd4ac"),
  cssText("--badge-brand-bg", "Brand badge background", "semantic-color", "#e3f3ea"),
  cssText("--badge-brand-text", "Brand badge text", "semantic-color", "#297f4e"),
  cssText("--badge-brand-border", "Brand badge border", "semantic-color", "#cbe9d8"),
  cssText("--badge-highlight-bg", "Highlight badge background", "semantic-color", "#f8f9f3"),
  cssText("--badge-highlight-text", "Highlight badge text", "semantic-color", "#111416"),
  cssText("--badge-highlight-border", "Highlight badge border", "semantic-color", "#f2f4e9"),
  cssText("--dark-color-bg", "Dark page background", "semantic-color", "#050e0d"),
  cssText("--dark-color-surface", "Dark surface", "semantic-color", "#091a13"),
  cssText("--dark-color-text", "Dark text", "semantic-color", "#f9fdfb"),
  cssText("--dark-color-border", "Dark border", "semantic-color", "rgba(171, 220, 192, 0.22)"),
  cssText("--color-nav-bg", "Navigation background", "semantic-color", "rgba(255, 255, 255, 0.9)"),
  cssText("--color-footer-muted", "Footer muted text", "semantic-color", "rgba(249, 253, 251, 0.76)"),
  ...
  cssText("--section-padding-x", "Section horizontal padding", "layout", "clamp(1rem, 2vw, 1.5rem)"),
  ...
  cssNumber("--hero-grid-text-fr", "Hero grid text fraction", "layout", 1.3, fractionRange),
  cssNumber("--hero-grid-visual-fr", "Hero grid visual fraction", "layout", 0.7, fractionRange),
  ...
  cssNumber("--footer-copy-max-width", "Footer copy max width", "layout", 40, contentRemRange),
  ...
  cssNumber("--button-font-size", "Button font size", "component-size", 0.8848, fontRemRange),
  ...
  cssNumber("--navbar-link-font-size", "Navbar link font size", "component-size", 0.8848, fontRemRange),
  cssNumber(
  ...
  cssNumber("--demo-canvas-left-fr", "Demo canvas left fraction", "component-size", 0.78, fractionRange),
  cssNumber("--demo-canvas-min-column", "Demo canvas min column", "component-size", 16, componentRemRange),
  cssNumber("--demo-canvas-right-fr", "Demo canvas right fraction", "component-size", 1.22, fractionRange),
  cssNumber("--demo-layer-font-size", "Demo layer font size", "component-size", 0.8848, fontRemRange),
  ...
  cssText("--shadow-soft", "Soft shadow", "elevation", "0 20px 60px rgba(5, 14, 13, 0.08)"),
  cssText("--shadow-raised", "Raised shadow", "elevation", "0 32px 100px rgba(5, 14, 13, 0.12)"),
  cssText("--shadow-brand", "Brand shadow", "elevation", "0 28px 84px rgba(49, 151, 92, 0.18)"),
  ...
  cssNumber("--font-size-display", "Display font size", "typography", 5.7923, fontRemRange),
  cssNumber("--font-size-h1", "H1 font size", "typography", 3.6558, fontRemRange),
  cssNumber("--font-size-h2", "H2 font size", "typography", 2.9123, fontRemRange),
  ...
  cssNumber("--font-size-body-lg", "Large body font size", "typography", 1.264, fontRemRange),
  cssNumber("--font-size-body", "Body font size", "typography", 1.0112, fontRemRange),
  cssNumber("--font-size-caption", "Caption font size", "typography", 0.7584, {
    ...fontRemRange,
    step: 0.001,
  }),
  cssNumber("--font-size-eyebrow", "Eyebrow font size", "typography", 0.632, fontRemRange),
  cssNumber("--line-height-root", "Root line height", "typography", 1.514, lineHeightRange),
  cssNumber("--line-height-display", "Display line height", "typography", 1.061, lineHeightRange),
  cssNumber("--line-height-h1", "H1 line height", "typography", 1.078, lineHeightRange),
  cssNumber("--line-height-h2", "H2 line height", "typography", 1.101, lineHeightRange),
  cssNumber("--line-height-h3", "H3 line height", "typography", 1.163, lineHeightRange),
  cssNumber("--line-height-h4", "H4 line height", "typography", 1.338, lineHeightRange),
  cssNumber("--line-height-body-lg", "Large body line height", "typography", 1.622, lineHeightRange),
  cssNumber("--line-height-body", "Body line height", "typography", 1.52, lineHeightRange),
  cssNumber("--line-height-caption", "Caption line height", "typography", 1.511, lineHeightRange),
  cssNumber("--line-height-eyebrow", "Eyebrow line height", "typography", 1.606, lineHeightRange),
  ...
  cssNumber("--letter-spacing-heading", "Heading letter spacing", "typography", 0.024, {
    min: -0.1,
    max: 0.2,
    step: 0.001,
    unit: "em",
