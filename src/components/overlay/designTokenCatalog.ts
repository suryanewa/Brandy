...
export const DESIGN_TOKEN_CATALOG = [
  cssColor("--brand-primary-50", "Primary 50", "palette", "#f6f5ff"),
  cssColor("--brand-primary-100", "Primary 100", "palette", "#e9e8ff"),
  cssColor("--brand-primary-200", "Primary 200", "palette", "#d6d4ff"),
  cssColor("--brand-primary-300", "Primary 300", "palette", "#bdbaff"),
  cssColor("--brand-primary-400", "Primary 400", "palette", "#958fff"),
  cssColor("--brand-primary-500", "Primary 500", "palette", "#635bff"),
  cssColor("--brand-primary-600", "Primary 600", "palette", "#5750e0"),
  cssColor("--brand-primary-700", "Primary 700", "palette", "#4943bd"),
  cssColor("--brand-primary-800", "Primary 800", "palette", "#393594"),
  cssColor("--brand-primary-900", "Primary 900", "palette", "#262361"),
  cssColor("--brand-primary-950", "Primary 950", "palette", "#161438"),
  cssColor("--brand-secondary-50", "Secondary 50", "palette", "#f0fcff"),
  cssColor("--brand-secondary-100", "Secondary 100", "palette", "#dbf9ff"),
  cssColor("--brand-secondary-200", "Secondary 200", "palette", "#bdf4ff"),
  cssColor("--brand-secondary-300", "Secondary 300", "palette", "#94edff"),
  cssColor("--brand-secondary-400", "Secondary 400", "palette", "#52e2ff"),
  cssColor("--brand-secondary-500", "Secondary 500", "palette", "#00d4ff"),
  cssColor("--brand-secondary-600", "Secondary 600", "palette", "#00bbe0"),
  cssColor("--brand-secondary-700", "Secondary 700", "palette", "#009dbd"),
  cssColor("--brand-secondary-800", "Secondary 800", "palette", "#007b94"),
  cssColor("--brand-secondary-900", "Secondary 900", "palette", "#005161"),
  cssColor("--brand-secondary-950", "Secondary 950", "palette", "#002f38"),
  ...
  cssColor("--neutral-50", "Neutral 50", "palette", "#fafaff"),
  cssColor("--neutral-100", "Neutral 100", "palette", "#f3f2ff"),
  cssColor("--neutral-200", "Neutral 200", "palette", "#e6e5ff"),
  cssColor("--neutral-300", "Neutral 300", "palette", "#d3d1ff"),
  cssColor("--neutral-400", "Neutral 400", "palette", "#bab7ff"),
  cssColor("--neutral-500", "Neutral 500", "palette", "#404885"),
  cssColor("--neutral-600", "Neutral 600", "palette", "#2e3463"),
  cssColor("--neutral-700", "Neutral 700", "palette", "#20244e"),
  cssColor("--neutral-800", "Neutral 800", "palette", "#191f44"),
  cssColor("--neutral-900", "Neutral 900", "palette", "#11132a"),
  cssColor("--neutral-950", "Neutral 950", "palette", "#080916"),
  cssColor("--white", "White", "palette", "#ffffff"),
  cssColor("--ink-950", "Ink 950", "palette", "#070814"),
  cssColor("--ink-800", "Ink 800", "palette", "#191f44"),
  cssColor("--ink-600", "Ink 600", "palette", "#2e3463"),
  cssColor("--ink-500", "Ink 500", "palette", "#404885"),
  cssColor("--mist-100", "Mist 100", "palette", "#f9f9ff"),
  cssColor("--mist-200", "Mist 200", "palette", "#f3f2ff"),
  cssColor("--mist-300", "Mist 300", "palette", "#e6e5ff"),
  cssColor("--green-600", "Green 600", "palette", "#5750e0"),
  cssColor("--green-700", "Green 700", "palette", "#4943bd"),
  cssColor("--green-100", "Green 100", "palette", "#e9e8ff"),
  cssColor("--blue-600", "Blue 600", "palette", "#00bbe0"),
  cssColor("--blue-100", "Blue 100", "palette", "#dbf9ff"),
  cssColor("--amber-500", "Amber 500", "palette", "#dc760a"),
  cssText("--color-bg", "Page background", "semantic-color", "#fafaff"),
  cssText("--color-surface", "Surface", "semantic-color", "#f9f9ff"),
  cssText("--color-surface-raised", "Raised surface", "semantic-color", "#ffffff"),
  cssText("--color-surface-strong", "Strong surface", "semantic-color", "#f3f2ff"),
  cssText("--color-text", "Text", "semantic-color", "#070814"),
  cssText("--color-muted", "Muted text", "semantic-color", "#2e3463"),
  cssText("--color-border", "Border", "semantic-color", "#e6e5ff"),
  cssText("--color-accent", "Accent", "semantic-color", "#5750e0"),
  cssText("--color-accent-hover", "Accent hover", "semantic-color", "#4943bd"),
  cssText("--color-accent-soft", "Soft accent", "semantic-color", "#e9e8ff"),
  cssText("--color-accent-border", "Accent border", "semantic-color", "rgba(99, 91, 255, 0.32)"),
  cssText("--color-blue", "Blue", "semantic-color", "#00bbe0"),
  cssText("--color-blue-soft", "Soft blue", "semantic-color", "#dbf9ff"),
  ...
  cssText("--color-success", "Success", "semantic-color", "#1c9d58"),
  cssText("--color-error", "Error", "semantic-color", "#df2c27"),
  cssText("--color-info", "Info", "semantic-color", "#2a62ed"),
  cssText("--button-primary-bg", "Primary button background", "semantic-color", "#5750e0"),
  cssText("--button-primary-hover", "Primary button hover", "semantic-color", "#4943bd"),
  cssText("--button-primary-text", "Primary button text", "semantic-color", "#ffffff"),
  cssText("--button-secondary-bg", "Secondary button background", "semantic-color", "#f0fcff"),
  cssText("--button-secondary-hover", "Secondary button hover", "semantic-color", "#dbf9ff"),
  cssText("--button-secondary-text", "Secondary button text", "semantic-color", "#007b94"),
  cssText("--button-secondary-border", "Secondary button border", "semantic-color", "#bdf4ff"),
  cssText("--link-color", "Link", "semantic-color", "#4943bd"),
  cssText("--link-hover", "Link hover", "semantic-color", "#393594"),
  cssText("--focus-ring", "Focus ring", "semantic-color", "#958fff"),
  cssText("--gradient-hero-start", "Hero gradient start", "semantic-color", "#5750e0"),
  cssText("--gradient-hero-end", "Hero gradient end", "semantic-color", "#00d4ff"),
  cssText("--gradient-hero-accent", "Hero gradient accent", "semantic-color", "#e05e2f"),
  cssColor("--chart-1", "Chart 1", "palette", "#5750e0"),
  cssColor("--chart-2", "Chart 2", "palette", "#00bbe0"),
  cssColor("--chart-3", "Chart 3", "palette", "#e05e2f"),
  cssColor("--chart-4", "Chart 4", "palette", "#fde68a"),
  cssText("--badge-brand-bg", "Brand badge background", "semantic-color", "#e9e8ff"),
  cssText("--badge-brand-text", "Brand badge text", "semantic-color", "#4943bd"),
  cssText("--badge-brand-border", "Brand badge border", "semantic-color", "#d6d4ff"),
  ...
  cssText("--dark-color-bg", "Dark page background", "semantic-color", "#080916"),
  cssText("--dark-color-surface", "Dark surface", "semantic-color", "#0f0f28"),
  cssText("--dark-color-text", "Dark text", "semantic-color", "#fafaff"),
  cssText("--dark-color-border", "Dark border", "semantic-color", "rgba(189, 186, 255, 0.22)"),
  cssText("--color-nav-bg", "Navigation background", "semantic-color", "rgba(255, 255, 255, 0.9)"),
  cssText("--color-footer-muted", "Footer muted text", "semantic-color", "rgba(250, 250, 255, 0.76)"),
  ...
  cssNumber("--radius-sm", "Small radius", "radii", 1, radiusRange),
  cssNumber("--radius-md", "Medium radius", "radii", 1.5, radiusRange),
  cssNumber("--radius-lg", "Large radius", "radii", 2, radiusRange),
  ...
  cssText("--shadow-soft", "Soft shadow", "elevation", "0 20px 60px rgba(8, 9, 22, 0.08)"),
  cssText("--shadow-raised", "Raised shadow", "elevation", "0 32px 100px rgba(8, 9, 22, 0.12)"),
  cssText("--shadow-brand", "Brand shadow", "elevation", "0 28px 84px rgba(87, 80, 224, 0.18)"),
