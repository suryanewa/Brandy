...
export const DESIGN_TOKEN_CATALOG = [
  cssColor("--brand-primary-50", "Primary 50", "palette", "#f9f5f8"),
  cssColor("--brand-primary-100", "Primary 100", "palette", "#f2e8ee"),
  cssColor("--brand-primary-200", "Primary 200", "palette", "#e6d4e0"),
  cssColor("--brand-primary-300", "Primary 300", "palette", "#d7b9cd"),
  cssColor("--brand-primary-400", "Primary 400", "palette", "#be8daf"),
  cssColor("--brand-primary-500", "Primary 500", "palette", "#a05889"),
  cssColor("--brand-primary-600", "Primary 600", "palette", "#8d4d79"),
  cssColor("--brand-primary-700", "Primary 700", "palette", "#764165"),
  cssColor("--brand-primary-800", "Primary 800", "palette", "#5d334f"),
  cssColor("--brand-primary-900", "Primary 900", "palette", "#3d2134"),
  cssColor("--brand-primary-950", "Primary 950", "palette", "#23131e"),
  cssColor("--brand-secondary-50", "Secondary 50", "palette", "#faf6f8"),
  cssColor("--brand-secondary-100", "Secondary 100", "palette", "#f2e9ef"),
  cssColor("--brand-secondary-200", "Secondary 200", "palette", "#e8d7e2"),
  cssColor("--brand-secondary-300", "Secondary 300", "palette", "#d9bed0"),
  cssColor("--brand-secondary-400", "Secondary 400", "palette", "#c296b4"),
  cssColor("--brand-secondary-500", "Secondary 500", "palette", "#a56490"),
  cssColor("--brand-secondary-600", "Secondary 600", "palette", "#91587f"),
  cssColor("--brand-secondary-700", "Secondary 700", "palette", "#7a4a6b"),
  cssColor("--brand-secondary-800", "Secondary 800", "palette", "#603a54"),
  cssColor("--brand-secondary-900", "Secondary 900", "palette", "#3f2637"),
  cssColor("--brand-secondary-950", "Secondary 950", "palette", "#241620"),
  cssColor("--brand-accent-50", "Accent 50", "palette", "#faf4f8"),
  cssColor("--brand-accent-100", "Accent 100", "palette", "#f4e6ef"),
  cssColor("--brand-accent-200", "Accent 200", "palette", "#ead0e2"),
  cssColor("--brand-accent-300", "Accent 300", "palette", "#ddb3d0"),
  cssColor("--brand-accent-400", "Accent 400", "palette", "#c985b3"),
  cssColor("--brand-accent-500", "Accent 500", "palette", "#af4b8f"),
  cssColor("--brand-accent-600", "Accent 600", "palette", "#9a427e"),
  cssColor("--brand-accent-700", "Accent 700", "palette", "#82386a"),
  cssColor("--brand-accent-800", "Accent 800", "palette", "#662c53"),
  cssColor("--brand-accent-900", "Accent 900", "palette", "#431d36"),
  cssColor("--brand-accent-950", "Accent 950", "palette", "#26101f"),
  cssColor("--brand-highlight-50", "Highlight 50", "palette", "#fcfbfc"),
  cssColor("--brand-highlight-100", "Highlight 100", "palette", "#f9f5f8"),
  cssColor("--brand-highlight-200", "Highlight 200", "palette", "#f4ecf1"),
  cssColor("--brand-highlight-300", "Highlight 300", "palette", "#ede0e9"),
  cssColor("--brand-highlight-400", "Highlight 400", "palette", "#e2cddb"),
  cssColor("--brand-highlight-500", "Highlight 500", "palette", "#d4b5ca"),
  cssColor("--brand-highlight-600", "Highlight 600", "palette", "#bb9fb2"),
  cssColor("--brand-highlight-700", "Highlight 700", "palette", "#9d8695"),
  cssColor("--brand-highlight-800", "Highlight 800", "palette", "#7b6975"),
  cssColor("--brand-highlight-900", "Highlight 900", "palette", "#51454d"),
  cssColor("--brand-highlight-950", "Highlight 950", "palette", "#2f282c"),
  cssColor("--neutral-50", "Neutral 50", "palette", "#fcfafb"),
  cssColor("--neutral-100", "Neutral 100", "palette", "#f7f2f6"),
  cssColor("--neutral-200", "Neutral 200", "palette", "#f0e4ec"),
  cssColor("--neutral-300", "Neutral 300", "palette", "#e4d0de"),
  cssColor("--neutral-400", "Neutral 400", "palette", "#d5b6cb"),
  cssColor("--neutral-500", "Neutral 500", "palette", "#524764"),
  cssColor("--neutral-600", "Neutral 600", "palette", "#3b3349"),
  cssColor("--neutral-700", "Neutral 700", "palette", "#2b2439"),
  cssColor("--neutral-800", "Neutral 800", "palette", "#201f35"),
  cssColor("--neutral-900", "Neutral 900", "palette", "#17131e"),
  cssColor("--neutral-950", "Neutral 950", "palette", "#0b090f"),
  cssColor("--white", "White", "palette", "#ffffff"),
  cssColor("--ink-950", "Ink 950", "palette", "#0a080e"),
  cssColor("--ink-800", "Ink 800", "palette", "#201f35"),
  cssColor("--ink-600", "Ink 600", "palette", "#3b3349"),
  cssColor("--ink-500", "Ink 500", "palette", "#524764"),
  cssColor("--mist-100", "Mist 100", "palette", "#fbf9fa"),
  cssColor("--mist-200", "Mist 200", "palette", "#f7f2f6"),
  cssColor("--mist-300", "Mist 300", "palette", "#f0e4ec"),
  cssColor("--green-600", "Green 600", "palette", "#8d4d79"),
  cssColor("--green-700", "Green 700", "palette", "#764165"),
  cssColor("--green-100", "Green 100", "palette", "#f2e8ee"),
  cssColor("--blue-600", "Blue 600", "palette", "#91587f"),
  cssColor("--blue-100", "Blue 100", "palette", "#f2e9ef"),
  cssColor("--amber-500", "Amber 500", "palette", "#d67311"),
  cssText("--color-bg", "Page background", "semantic-color", "#fcfafb"),
  cssText("--color-surface", "Surface", "semantic-color", "#fbf9fa"),
  cssText("--color-surface-raised", "Raised surface", "semantic-color", "#ffffff"),
  cssText("--color-surface-strong", "Strong surface", "semantic-color", "#f7f2f6"),
  cssText("--color-text", "Text", "semantic-color", "#0a080e"),
  cssText("--color-muted", "Muted text", "semantic-color", "#3b3349"),
  cssText("--color-border", "Border", "semantic-color", "#f0e4ec"),
  cssText("--color-accent", "Accent", "semantic-color", "#8d4d79"),
  cssText("--color-accent-hover", "Accent hover", "semantic-color", "#764165"),
  cssText("--color-accent-soft", "Soft accent", "semantic-color", "#f2e8ee"),
  cssText("--color-accent-border", "Accent border", "semantic-color", "rgba(160, 88, 137, 0.32)"),
  cssText("--color-blue", "Blue", "semantic-color", "#91587f"),
  cssText("--color-blue-soft", "Soft blue", "semantic-color", "#f2e9ef"),
  cssText("--color-on-accent", "On accent", "semantic-color", "#ffffff"),
  cssText("--color-highlight", "Highlight", "semantic-color", "#e2cddb"),
  cssText("--color-highlight-soft", "Soft highlight", "semantic-color", "#f9f5f8"),
  cssText("--color-on-highlight", "On highlight", "semantic-color", "#111416"),
  cssText("--color-warning", "Warning", "semantic-color", "var(--amber-500)"),
  cssText("--color-success", "Success", "semantic-color", "#219d4f"),
  cssText("--color-error", "Error", "semantic-color", "#d8292e"),
  cssText("--color-info", "Info", "semantic-color", "#2f62e3"),
  cssText("--button-primary-bg", "Primary button background", "semantic-color", "#8d4d79"),
  cssText("--button-primary-hover", "Primary button hover", "semantic-color", "#764165"),
  cssText("--button-primary-text", "Primary button text", "semantic-color", "#ffffff"),
  cssText("--button-secondary-bg", "Secondary button background", "semantic-color", "#faf6f8"),
  cssText("--button-secondary-hover", "Secondary button hover", "semantic-color", "#f2e9ef"),
  cssText("--button-secondary-text", "Secondary button text", "semantic-color", "#603a54"),
  cssText("--button-secondary-border", "Secondary button border", "semantic-color", "#e8d7e2"),
  cssText("--link-color", "Link", "semantic-color", "#764165"),
  cssText("--link-hover", "Link hover", "semantic-color", "#5d334f"),
  cssText("--focus-ring", "Focus ring", "semantic-color", "#be8daf"),
  cssText("--gradient-hero-start", "Hero gradient start", "semantic-color", "#8d4d79"),
  cssText("--gradient-hero-end", "Hero gradient end", "semantic-color", "#a56490"),
  cssText("--gradient-hero-accent", "Hero gradient accent", "semantic-color", "#9a427e"),
  cssColor("--chart-1", "Chart 1", "palette", "#8d4d79"),
  cssColor("--chart-2", "Chart 2", "palette", "#91587f"),
  cssColor("--chart-3", "Chart 3", "palette", "#9a427e"),
  cssColor("--chart-4", "Chart 4", "palette", "#d4b5ca"),
  cssText("--badge-brand-bg", "Brand badge background", "semantic-color", "#f2e8ee"),
  cssText("--badge-brand-text", "Brand badge text", "semantic-color", "#764165"),
  cssText("--badge-brand-border", "Brand badge border", "semantic-color", "#e6d4e0"),
  cssText("--badge-highlight-bg", "Highlight badge background", "semantic-color", "#f9f5f8"),
  cssText("--badge-highlight-text", "Highlight badge text", "semantic-color", "#7b6975"),
  cssText("--badge-highlight-border", "Highlight badge border", "semantic-color", "#f4ecf1"),
  cssText("--dark-color-bg", "Dark page background", "semantic-color", "#0b090f"),
  cssText("--dark-color-surface", "Dark surface", "semantic-color", "#170f18"),
  cssText("--dark-color-text", "Dark text", "semantic-color", "#fcfafb"),
  cssText("--dark-color-border", "Dark border", "semantic-color", "rgba(215, 185, 205, 0.22)"),
  cssText("--color-nav-bg", "Navigation background", "semantic-color", "rgba(255, 255, 255, 0.9)"),
  cssText("--color-footer-muted", "Footer muted text", "semantic-color", "rgba(252, 250, 251, 0.76)"),
  ...
  cssText("--section-padding-x", "Section horizontal padding", "layout", "clamp(1.25rem, 3.68vw, 2.76rem)"),
  cssText("--section-padding-y-sm", "Small section padding", "layout", "3.57rem"),
  cssText("--section-padding-y-md", "Medium section padding", "layout", "5.95rem"),
  cssText("--section-padding-y-lg", "Large section padding", "layout", "7.14rem"),
  ...
  cssText("--content-readable-max", "Readable content max", "layout", "47rem"),
  cssText(
  ...
  cssText("--brandy-cluster-default-gap", "Default cluster gap", "layout", "var(--space-7)"),
  cssText("--brandy-stack-default-gap", "Default stack gap", "layout", "var(--space-8)"),
  cssNumber("--hero-grid-text-fr", "Hero grid text fraction", "layout", 0.8, fractionRange),
  cssNumber("--hero-grid-visual-fr", "Hero grid visual fraction", "layout", 1.2, fractionRange),
  ...
  cssNumber("--hero-description-max-width", "Hero description max width", "layout", 47, contentRemRange),
  cssNumber("--footer-copy-max-width", "Footer copy max width", "layout", 35, contentRemRange),
  cssText("--footer-columns", "Footer columns", "layout", "1fr"),
  ...
  cssNumber("--button-font-size", "Button font size", "component-size", 0.8589, fontRemRange),
  cssNumber("--button-font-weight", "Button font weight", "component-size", 700, fontWeightRange),
  ...
  cssNumber("--badge-font-weight", "Badge font weight", "component-size", 700, fontWeightRange),
  cssText("--card-padding", "Card padding", "component-size", "1.78rem"),
  cssNumber("--navbar-min-height", "Navbar min height", "component-size", 4.25, componentRemRange),
  cssNumber("--navbar-link-font-size", "Navbar link font size", "component-size", 0.8589, fontRemRange),
  cssNumber(
  ...
  cssNumber("--demo-canvas-left-fr", "Demo canvas left fraction", "component-size", 1.14, fractionRange),
  cssNumber("--demo-canvas-min-column", "Demo canvas min column", "component-size", 16, componentRemRange),
  cssNumber("--demo-canvas-right-fr", "Demo canvas right fraction", "component-size", 0.86, fractionRange),
  cssNumber("--demo-layer-font-size", "Demo layer font size", "component-size", 0.8589, fontRemRange),
  ...
  cssNumber("--feature-card-min-height", "Feature card min height", "component-size", 16, componentRemRange),
  cssNumber("--step-card-min-height", "Step card min height", "component-size", 18, componentRemRange),
  cssNumber("--faq-trigger-min-height", "FAQ trigger min height", "component-size", 5.35, componentRemRange),
  cssNumber("--radius-sm", "Small radius", "radii", 7, radiusRange),
  cssNumber("--radius-md", "Medium radius", "radii", 10.5, radiusRange),
  cssNumber("--radius-lg", "Large radius", "radii", 14, radiusRange),
  ...
  cssText("--shadow-soft", "Soft shadow", "elevation", "0 20px 60px rgba(11, 9, 15, 0.08)"),
  cssText("--shadow-raised", "Raised shadow", "elevation", "0 32px 100px rgba(11, 9, 15, 0.12)"),
  cssText("--shadow-brand", "Brand shadow", "elevation", "0 28px 84px rgba(141, 77, 121, 0.18)"),
  ...
  cssText(
    "--font-family-heading",
    "Heading font family",
    "typography", "\"IBM Plex Mono\", \"SFMono-Regular\", \"Cascadia Code\", monospace",
  ),
  cssText(
    "--font-family-body",
    "Body font family",
  ...
  cssNumber("--font-size-display", "Display font size", "typography", 5.4517, fontRemRange),
  cssNumber("--font-size-h1", "H1 font size", "typography", 3.4272, fontRemRange),
  cssNumber("--font-size-h2", "H2 font size", "typography", 2.7301, fontRemRange),
  cssNumber("--font-size-h3", "H3 font size", "typography", 1.9724, fontRemRange),
  cssNumber("--font-size-h4", "H4 font size", "typography", 1.4345, fontRemRange),
  cssNumber("--font-size-body-lg", "Large body font size", "typography", 1.227, fontRemRange),
  cssNumber("--font-size-body", "Body font size", "typography", 0.9816, fontRemRange),
  cssNumber("--font-size-caption", "Caption font size", "typography", 0.7362, {
    ...fontRemRange,
    step: 0.001,
  }),
  cssNumber("--font-size-eyebrow", "Eyebrow font size", "typography", 0.6135, fontRemRange),
  cssNumber("--line-height-root", "Root line height", "typography", 1.477, lineHeightRange),
  cssNumber("--line-height-display", "Display line height", "typography", 0.984, lineHeightRange),
  cssNumber("--line-height-h1", "H1 line height", "typography", 1.024, lineHeightRange),
  cssNumber("--line-height-h2", "H2 line height", "typography", 1.06, lineHeightRange),
  cssNumber("--line-height-h3", "H3 line height", "typography", 1.136, lineHeightRange),
  cssNumber("--line-height-h4", "H4 line height", "typography", 1.322, lineHeightRange),
  cssNumber("--line-height-body-lg", "Large body line height", "typography", 1.563, lineHeightRange),
  cssNumber("--line-height-body", "Body line height", "typography", 1.468, lineHeightRange),
  cssNumber("--line-height-caption", "Caption line height", "typography", 1.482, lineHeightRange),
  cssNumber("--line-height-eyebrow", "Eyebrow line height", "typography", 1.593, lineHeightRange),
  cssNumber("--font-weight-heading", "Heading font weight", "typography", 710, fontWeightRange),
  cssNumber("--font-weight-body", "Body font weight", "typography", 400, fontWeightRange),
  cssNumber("--font-weight-strong", "Strong font weight", "typography", 750, fontWeightRange),
  cssNumber("--font-weight-label", "Label font weight", "typography", 740, fontWeightRange),
  cssNumber("--letter-spacing-heading", "Heading letter spacing", "typography", -0.001, {
    min: -0.1,
    max: 0.2,
    step: 0.001,
    unit: "em",
  }),
  cssNumber("--letter-spacing-eyebrow", "Eyebrow letter spacing", "typography", 0.021, {
    min: -0.1,
    max: 0.2,
    step: 0.001,
    unit: "em",
