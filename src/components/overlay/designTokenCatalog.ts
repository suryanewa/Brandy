...
export const DESIGN_TOKEN_CATALOG = [
  ...
  cssText("--section-padding-x", "Section horizontal padding", "layout", "clamp(1.25rem, 2.96vw, 2.22rem)"),
  cssText("--section-padding-y-sm", "Small section padding", "layout", "3.54rem"),
  cssText("--section-padding-y-md", "Medium section padding", "layout", "5.9rem"),
  cssText("--section-padding-y-lg", "Large section padding", "layout", "7.08rem"),
  ...
  cssNumber("--button-font-size", "Button font size", "component-size", 0.8666, fontRemRange),
  ...
  cssText("--card-padding", "Card padding", "component-size", "1.77rem"),
  ...
  cssNumber("--navbar-link-font-size", "Navbar link font size", "component-size", 0.8666, fontRemRange),
  cssText(
  ...
  cssNumber("--demo-layer-font-size", "Demo layer font size", "component-size", 0.8666, fontRemRange),
  ...
  cssNumber("--faq-trigger-min-height", "FAQ trigger min height", "component-size", 5.31, componentRemRange),
  ...
  cssNumber("--font-size-display", "Display font size", "typography", 6.2274, fontRemRange),
  cssNumber("--font-size-h1", "H1 font size", "typography", 3.8563, fontRemRange),
  cssNumber("--font-size-h2", "H2 font size", "typography", 3.072, fontRemRange),
  ...
  cssNumber("--font-size-body-lg", "Large body font size", "typography", 1.238, fontRemRange),
  cssNumber("--font-size-body", "Body font size", "typography", 0.9904, fontRemRange),
  cssNumber("--font-size-caption", "Caption font size", "typography", 0.7428, {
    ...fontRemRange,
    step: 0.001,
  }),
  cssNumber("--font-size-eyebrow", "Eyebrow font size", "typography", 0.619, fontRemRange),
  cssNumber("--line-height-root", "Root line height", "typography", 1.488, lineHeightRange),
  cssNumber("--line-height-display", "Display line height", "typography", 0.995, lineHeightRange),
  cssNumber("--line-height-h1", "H1 line height", "typography", 1.035, lineHeightRange),
  cssNumber("--line-height-h2", "H2 line height", "typography", 1.069, lineHeightRange),
  cssNumber("--line-height-h3", "H3 line height", "typography", 1.146, lineHeightRange),
  cssNumber("--line-height-h4", "H4 line height", "typography", 1.328, lineHeightRange),
  cssNumber("--line-height-body-lg", "Large body line height", "typography", 1.581, lineHeightRange),
  cssNumber("--line-height-body", "Body line height", "typography", 1.483, lineHeightRange),
  cssNumber("--line-height-caption", "Caption line height", "typography", 1.49, lineHeightRange),
  cssNumber("--line-height-eyebrow", "Eyebrow line height", "typography", 1.598, lineHeightRange),
  cssNumber("--font-weight-heading", "Heading font weight", "typography", 800, fontWeightRange),
  cssNumber("--font-weight-body", "Body font weight", "typography", 420, fontWeightRange),
  cssNumber("--font-weight-strong", "Strong font weight", "typography", 840, fontWeightRange),
  cssNumber("--font-weight-label", "Label font weight", "typography", 780, fontWeightRange),
  cssNumber("--letter-spacing-heading", "Heading letter spacing", "typography", -0.01, {
    min: -0.1,
    max: 0.2,
    step: 0.001,
    unit: "em",
