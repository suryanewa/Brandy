...
export const DESIGN_TOKEN_CATALOG = [
  cssColor("--brand-primary-50", "Primary 50", "palette", "#f8f1f7"),
  cssColor("--brand-primary-100", "Primary 100", "palette", "#eedfed"),
  cssColor("--brand-primary-200", "Primary 200", "palette", "#e0c3dd"),
  cssColor("--brand-primary-300", "Primary 300", "palette", "#cc9ec8"),
  cssColor("--brand-primary-400", "Primary 400", "palette", "#ad62a6"),
  cssColor("--brand-primary-500", "Primary 500", "palette", "#86187c"),
  cssColor("--brand-primary-600", "Primary 600", "palette", "#76156d"),
  cssColor("--brand-primary-700", "Primary 700", "palette", "#63125c"),
  cssColor("--brand-primary-800", "Primary 800", "palette", "#4e0e48"),
  cssColor("--brand-primary-900", "Primary 900", "palette", "#33092f"),
  cssColor("--brand-primary-950", "Primary 950", "palette", "#1d051b"),
  cssColor("--brand-secondary-50", "Secondary 50", "palette", "#f8f8f2"),
  cssColor("--brand-secondary-100", "Secondary 100", "palette", "#eeefe0"),
  cssColor("--brand-secondary-200", "Secondary 200", "palette", "#dfe2c6"),
  cssColor("--brand-secondary-300", "Secondary 300", "palette", "#cbd0a2"),
  cssColor("--brand-secondary-400", "Secondary 400", "palette", "#abb269"),
  cssColor("--brand-secondary-500", "Secondary 500", "palette", "#848e22"),
  cssColor("--brand-secondary-600", "Secondary 600", "palette", "#747d1e"),
  cssColor("--brand-secondary-700", "Secondary 700", "palette", "#626919"),
  cssColor("--brand-secondary-800", "Secondary 800", "palette", "#4d5214"),
  cssColor("--brand-secondary-900", "Secondary 900", "palette", "#32360d"),
  cssColor("--brand-secondary-950", "Secondary 950", "palette", "#1d1f07"),
  cssColor("--brand-accent-50", "Accent 50", "palette", "#f1f9fa"),
  cssColor("--brand-accent-100", "Accent 100", "palette", "#dff2f4"),
  cssColor("--brand-accent-200", "Accent 200", "palette", "#c4e7ea"),
  cssColor("--brand-accent-300", "Accent 300", "palette", "#9fd8dd"),
  cssColor("--brand-accent-400", "Accent 400", "palette", "#64c0c9"),
  cssColor("--brand-accent-500", "Accent 500", "palette", "#1ba2af"),
  cssColor("--brand-accent-600", "Accent 600", "palette", "#188f9a"),
  cssColor("--brand-accent-700", "Accent 700", "palette", "#147882"),
  cssColor("--brand-accent-800", "Accent 800", "palette", "#105e66"),
  cssColor("--brand-accent-900", "Accent 900", "palette", "#0a3e43"),
  cssColor("--brand-accent-950", "Accent 950", "palette", "#062426"),
  cssColor("--brand-highlight-50", "Highlight 50", "palette", "#fdf8f9"),
  cssColor("--brand-highlight-100", "Highlight 100", "palette", "#faf0f1"),
  cssColor("--brand-highlight-200", "Highlight 200", "palette", "#f5e3e5"),
  cssColor("--brand-highlight-300", "Highlight 300", "palette", "#efd1d5"),
  cssColor("--brand-highlight-400", "Highlight 400", "palette", "#e5b5ba"),
  cssColor("--brand-highlight-500", "Highlight 500", "palette", "#d9929a"),
  cssColor("--brand-highlight-600", "Highlight 600", "palette", "#bf8088"),
  cssColor("--brand-highlight-700", "Highlight 700", "palette", "#a16c72"),
  cssColor("--brand-highlight-800", "Highlight 800", "palette", "#7e5559"),
  cssColor("--brand-highlight-900", "Highlight 900", "palette", "#52373b"),
  cssColor("--brand-highlight-950", "Highlight 950", "palette", "#302022"),
  cssColor("--neutral-50", "Neutral 50", "palette", "#fbf8fb"),
  cssColor("--neutral-100", "Neutral 100", "palette", "#f5edf5"),
  cssColor("--neutral-200", "Neutral 200", "palette", "#ecdaea"),
  cssColor("--neutral-300", "Neutral 300", "palette", "#ddbeda"),
  cssColor("--neutral-400", "Neutral 400", "palette", "#ca99c5"),
  cssColor("--neutral-500", "Neutral 500", "palette", "#4a3660"),
  cssColor("--neutral-600", "Neutral 600", "palette", "#362546"),
  cssColor("--neutral-700", "Neutral 700", "palette", "#261836"),
  cssColor("--neutral-800", "Neutral 800", "palette", "#1d1734"),
  cssColor("--neutral-900", "Neutral 900", "palette", "#150c1d"),
  cssColor("--neutral-950", "Neutral 950", "palette", "#0a050e"),
  cssColor("--white", "White", "palette", "#ffffff"),
  cssColor("--ink-950", "Ink 950", "palette", "#09050d"),
  cssColor("--ink-800", "Ink 800", "palette", "#1d1734"),
  cssColor("--ink-600", "Ink 600", "palette", "#362546"),
  cssColor("--ink-500", "Ink 500", "palette", "#4a3660"),
  cssColor("--mist-100", "Mist 100", "palette", "#faf6fa"),
  cssColor("--mist-200", "Mist 200", "palette", "#f5edf5"),
  cssColor("--mist-300", "Mist 300", "palette", "#ecdaea"),
  cssColor("--green-600", "Green 600", "palette", "#76156d"),
  cssColor("--green-700", "Green 700", "palette", "#63125c"),
  cssColor("--green-100", "Green 100", "palette", "#eedfed"),
  cssColor("--blue-600", "Blue 600", "palette", "#747d1e"),
  cssColor("--blue-100", "Blue 100", "palette", "#eeefe0"),
  cssColor("--amber-500", "Amber 500", "palette", "#ca7a14"),
  cssText("--color-bg", "Page background", "semantic-color", "#fbf8fb"),
  cssText("--color-surface", "Surface", "semantic-color", "#faf6fa"),
  cssText("--color-surface-raised", "Raised surface", "semantic-color", "#ffffff"),
  cssText("--color-surface-strong", "Strong surface", "semantic-color", "#f5edf5"),
  cssText("--color-text", "Text", "semantic-color", "#09050d"),
  cssText("--color-muted", "Muted text", "semantic-color", "#362546"),
  cssText("--color-section-text", "Section text", "semantic-color", "#09050d"),
  cssText("--color-section-muted", "Section muted text", "semantic-color", "#362546"),
  cssText("--color-surface-text", "Surface text", "semantic-color", "#09050d"),
  cssText("--color-surface-muted", "Surface muted text", "semantic-color", "#362546"),
  cssText("--color-card-text", "Card text", "semantic-color", "#09050d"),
  cssText("--color-card-muted", "Card muted text", "semantic-color", "#362546"),
  ...
  cssText("--color-inverted-text", "Inverted section text", "semantic-color", "#fbf8fb"),
  cssText("--color-inverted-muted", "Inverted muted text", "semantic-color", "#ffffff"),
  cssText("--color-border", "Border", "semantic-color", "#ecdaea"),
  cssText("--color-accent", "Accent", "semantic-color", "#76156d"),
  cssText("--color-accent-hover", "Accent hover", "semantic-color", "#63125c"),
  cssText("--color-accent-soft", "Soft accent", "semantic-color", "#eedfed"),
  cssText("--color-accent-border", "Accent border", "semantic-color", "rgba(134, 24, 124, 0.32)"),
  cssText("--color-blue", "Blue", "semantic-color", "#747d1e"),
  cssText("--color-blue-soft", "Soft blue", "semantic-color", "#eeefe0"),
  cssText("--color-on-accent", "On accent", "semantic-color", "#ffffff"),
  cssText("--color-highlight", "Highlight", "semantic-color", "#e5b5ba"),
  cssText("--color-highlight-soft", "Soft highlight", "semantic-color", "#faf0f1"),
  cssText("--color-on-highlight", "On highlight", "semantic-color", "#111416"),
  cssText("--color-warning", "Warning", "semantic-color", "var(--amber-500)"),
  cssText("--color-success", "Success", "semantic-color", "#1f984e"),
  cssText("--color-error", "Error", "semantic-color", "#cd3031"),
  cssText("--color-info", "Info", "semantic-color", "#2d5de2"),
  cssText("--button-primary-bg", "Primary button background", "semantic-color", "#76156d"),
  cssText("--button-primary-hover", "Primary button hover", "semantic-color", "#63125c"),
  cssText("--button-primary-text", "Primary button text", "semantic-color", "#ffffff"),
  cssText("--button-secondary-bg", "Secondary button background", "semantic-color", "#f8f8f2"),
  cssText("--button-secondary-hover", "Secondary button hover", "semantic-color", "#eeefe0"),
  cssText("--button-secondary-text", "Secondary button text", "semantic-color", "#4d5214"),
  cssText("--button-secondary-border", "Secondary button border", "semantic-color", "#dfe2c6"),
  cssText("--link-color", "Link", "semantic-color", "#63125c"),
  cssText("--link-hover", "Link hover", "semantic-color", "#4e0e48"),
  cssText("--focus-ring", "Focus ring", "semantic-color", "#ad62a6"),
  cssText("--gradient-hero-start", "Hero gradient start", "semantic-color", "#76156d"),
  cssText("--gradient-hero-end", "Hero gradient end", "semantic-color", "#848e22"),
  cssText("--gradient-hero-accent", "Hero gradient accent", "semantic-color", "#188f9a"),
  cssColor("--chart-1", "Chart 1", "palette", "#76156d"),
  cssColor("--chart-2", "Chart 2", "palette", "#747d1e"),
  cssColor("--chart-3", "Chart 3", "palette", "#188f9a"),
  cssColor("--chart-4", "Chart 4", "palette", "#d9929a"),
  cssText("--badge-brand-bg", "Brand badge background", "semantic-color", "#eedfed"),
  cssText("--badge-brand-text", "Brand badge text", "semantic-color", "#63125c"),
  cssText("--badge-brand-border", "Brand badge border", "semantic-color", "#e0c3dd"),
  cssText("--badge-highlight-bg", "Highlight badge background", "semantic-color", "#faf0f1"),
  cssText("--badge-highlight-text", "Highlight badge text", "semantic-color", "#7e5559"),
  cssText("--badge-highlight-border", "Highlight badge border", "semantic-color", "#f5e3e5"),
  cssText("--dark-color-bg", "Dark page background", "semantic-color", "#0a050e"),
  cssText("--dark-color-surface", "Dark surface", "semantic-color", "#140616"),
  cssText("--dark-color-text", "Dark text", "semantic-color", "#fbf8fb"),
  cssText("--dark-color-border", "Dark border", "semantic-color", "rgba(204, 158, 200, 0.22)"),
  cssText("--color-nav-bg", "Navigation background", "semantic-color", "#ffffff"),
  cssText("--color-nav-border", "Navigation border", "semantic-color", "#ecdaea"),
  cssText("--color-nav-lockup-logo", "Navigation lockup logo", "semantic-color", "#86187c"),
  cssText("--color-nav-link", "Navigation link", "semantic-color", "#362546"),
  cssText("--color-nav-link-hover", "Navigation link hover", "semantic-color", "#09050d"),
  cssText("--color-marquee-logo", "Marquee logo", "semantic-color", "#362546"),
  cssText("--color-footer-bg", "Footer background", "semantic-color", "#09050d"),
  cssText("--color-footer-border", "Footer border", "semantic-color", "#ecdaea"),
  cssText("--color-footer-text", "Footer text", "semantic-color", "#ffffff"),
  cssText("--color-footer-link", "Footer link", "semantic-color", "#e0c3dd"),
  cssText("--color-footer-link-hover", "Footer link hover", "semantic-color", "#f8f1f7"),
  ...
  cssText("--section-padding-x", "Section horizontal padding", "layout", "clamp(1.25rem, 2.56vw, 1.92rem)"),
  ...
  cssText("--content-readable-max", "Readable content max", "layout", "34rem"),
  cssText(
  ...
  cssNumber("--hero-grid-text-fr", "Hero grid text fraction", "layout", 0.9, fractionRange),
  cssNumber("--hero-grid-visual-fr", "Hero grid visual fraction", "layout", 1.1, fractionRange),
  ...
  cssNumber("--lockup-logo-size", "Lockup logo size", "component-size", 44, lockupPxRange),
  cssText(
  ...
  cssNumber("--lockup-wordmark-tracking", "Lockup wordmark tracking", "component-size", 2.8, {
    min: -2,
    max: 10,
    step: 0.1,
    unit: "px",
  }),
  cssNumber("--lockup-gap", "Lockup gap", "component-size", 14, lockupPxRange),
  ...
  cssNumber("--demo-canvas-left-fr", "Demo canvas left fraction", "component-size", 1.07, fractionRange),
  cssNumber("--demo-canvas-min-column", "Demo canvas min column", "component-size", 16, componentRemRange),
  cssNumber("--demo-canvas-right-fr", "Demo canvas right fraction", "component-size", 0.93, fractionRange),
  ...
  cssNumber("--radius-sm", "Small radius", "radii", 3.5, radiusRange),
  cssNumber("--radius-md", "Medium radius", "radii", 5.25, radiusRange),
  cssNumber("--radius-lg", "Large radius", "radii", 7, radiusRange),
  ...
  cssText("--shadow-soft", "Soft shadow", "elevation", "0 20px 60px rgba(10, 5, 14, 0.08)"),
  cssText("--shadow-raised", "Raised shadow", "elevation", "0 32px 100px rgba(10, 5, 14, 0.12)"),
  cssText("--shadow-brand", "Brand shadow", "elevation", "0 28px 84px rgba(118, 21, 109, 0.18)"),
  ...
  cssText(
    "--font-family-heading",
    "Heading font family",
    "typography", "\"Abril Fatface\", Georgia, \"Times New Roman\", serif",
  ),
  cssText(
    "--font-family-body",
    "Body font family",
    "typography", "Karla, Inter, ui-sans-serif, system-ui, sans-serif",
  ),
  cssNumber("--font-size-display", "Display font size", "typography", 6.9685, fontRemRange),
  cssNumber("--font-size-h1", "H1 font size", "typography", 4.2702, fontRemRange),
  cssNumber("--font-size-h2", "H2 font size", "typography", 3.4017, fontRemRange),
  cssNumber("--font-size-h3", "H3 font size", "typography", 2.1864, fontRemRange),
  cssNumber("--font-size-h4", "H4 font size", "typography", 1.5901, fontRemRange),
  ...
  cssNumber("--line-height-display", "Display line height", "typography", 0.967, lineHeightRange),
  cssNumber("--line-height-h1", "H1 line height", "typography", 1.018, lineHeightRange),
  cssNumber("--line-height-h2", "H2 line height", "typography", 1.056, lineHeightRange),
  cssNumber("--line-height-h3", "H3 line height", "typography", 1.14, lineHeightRange),
  cssNumber("--line-height-h4", "H4 line height", "typography", 1.324, lineHeightRange),
  ...
  cssNumber("--line-height-eyebrow", "Eyebrow line height", "typography", 1.595, lineHeightRange),
  ...
  cssNumber("--letter-spacing-eyebrow", "Eyebrow letter spacing", "typography", 0.014, {
    min: -0.1,
    max: 0.2,
    step: 0.001,
    unit: "em",
