...
export const DESIGN_TOKEN_CATALOG = [
  cssColor("--white", "White", "palette", "#fefefe"),
  cssColor("--ink-950", "Ink 950", "palette", "#050708"),
  cssColor("--ink-800", "Ink 800", "palette", "#191b1c"),
  cssColor("--ink-600", "Ink 600", "palette", "#4b4c4d"),
  cssColor("--ink-500", "Ink 500", "palette", "#5f6061"),
  cssColor("--mist-100", "Mist 100", "palette", "#fafafa"),
  cssColor("--mist-200", "Mist 200", "palette", "#cecece"),
  cssColor("--mist-300", "Mist 300", "palette", "#8f8f90"),
  cssColor("--green-600", "Green 600", "palette", "#0d845c"),
  cssColor("--green-700", "Green 700", "palette", "#095f42"),
  cssColor("--green-100", "Green 100", "palette", "#bbdcd1"),
  cssColor("--blue-600", "Blue 600", "palette", "#2054c7"),
  cssColor("--blue-100", "Blue 100", "palette", "#c0ceef"),
  cssColor("--amber-500", "Amber 500", "palette", "#bf7a18"),
  cssText("--color-bg", "Page background", "semantic-color", "#ffffff"),
  cssText("--color-surface", "Surface", "semantic-color", "#fafafa"),
  cssText("--color-surface-raised", "Raised surface", "semantic-color", "#fefefe"),
  cssText("--color-surface-strong", "Strong surface", "semantic-color", "#cecece"),
  cssText("--color-text", "Text", "semantic-color", "#050708"),
  cssText("--color-muted", "Muted text", "semantic-color", "#4b4c4d"),
  cssText("--color-border", "Border", "semantic-color", "#8f8f90"),
  cssText("--color-accent", "Accent", "semantic-color", "#0d845c"),
  cssText("--color-accent-hover", "Accent hover", "semantic-color", "#095f42"),
  cssText("--color-accent-soft", "Soft accent", "semantic-color", "#bbdcd1"),
  cssText("--color-accent-border", "Accent border", "semantic-color", "rgba(13, 132, 92, 0.62)"),
  cssText("--color-blue", "Blue", "semantic-color", "#2054c7"),
  cssText("--color-blue-soft", "Soft blue", "semantic-color", "#c0ceef"),
  cssText("--color-warning", "Warning", "semantic-color", "var(--amber-500)"),
  cssText("--color-nav-bg", "Navigation background", "semantic-color", "rgba(254, 254, 254, 0.94)"),
  cssText("--color-footer-muted", "Footer muted text", "semantic-color", "rgba(255, 255, 255, 0.86)"),
  ...
  cssText("--content-readable-max", "Readable content max", "layout", "calc(var(--container-sm) + 40px)"),
  cssText(
  ...
  cssText("--card-padding", "Card padding", "component-size", "var(--space-6)"),
  ...
  cssNumber("--demo-canvas-left-fr", "Demo canvas left fraction", "component-size", 1.2, fractionRange),
  cssNumber("--demo-canvas-min-column", "Demo canvas min column", "component-size", 16, componentRemRange),
  cssNumber("--demo-canvas-right-fr", "Demo canvas right fraction", "component-size", 0.8, fractionRange),
  ...
  cssNumber("--faq-trigger-min-height", "FAQ trigger min height", "component-size", 4.5, componentRemRange),
  ...
  cssText("--shadow-soft", "Soft shadow", "elevation", "0 20px 60px rgba(17, 20, 22, 0.08)"),
  cssText("--shadow-raised", "Raised shadow", "elevation", "0 32px 100px rgba(17, 20, 22, 0.12)"),
  ...
  cssNumber("--font-size-display", "Display font size", "typography", 5.5225, fontRemRange),
  cssNumber("--font-size-h1", "H1 font size", "typography", 3.4662, fontRemRange),
  cssNumber("--font-size-h2", "H2 font size", "typography", 2.7612, fontRemRange),
  cssNumber("--font-size-h3", "H3 font size", "typography", 1.9387, fontRemRange),
  cssNumber("--font-size-h4", "H4 font size", "typography", 1.41, fontRemRange),
  cssNumber("--font-size-body-lg", "Large body font size", "typography", 1.175, fontRemRange),
  cssNumber("--font-size-body", "Body font size", "typography", 0.94, fontRemRange),
  cssNumber("--font-size-caption", "Caption font size", "typography", 0.705, {
    ...fontRemRange,
    step: 0.001,
  }),
  cssNumber("--font-size-eyebrow", "Eyebrow font size", "typography", 0.5875, fontRemRange),
