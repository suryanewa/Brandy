...
export const DESIGN_TOKEN_CATALOG = [
  cssColor("--brand-primary-50", "Primary 50", "palette", "#f7f1f6"),
  cssColor("--brand-primary-100", "Primary 100", "palette", "#eddfe9"),
  cssColor("--brand-primary-200", "Primary 200", "palette", "#ddc3d7"),
  cssColor("--brand-primary-300", "Primary 300", "palette", "#c89ebe"),
  cssColor("--brand-primary-400", "Primary 400", "palette", "#a76296"),
  cssColor("--brand-primary-500", "Primary 500", "palette", "#7d1864"),
  cssColor("--brand-primary-600", "Primary 600", "palette", "#6e1558"),
  cssColor("--brand-primary-700", "Primary 700", "palette", "#5d124a"),
  cssColor("--brand-primary-800", "Primary 800", "palette", "#490e3a"),
  cssColor("--brand-primary-900", "Primary 900", "palette", "#300926"),
  cssColor("--brand-primary-950", "Primary 950", "palette", "#1b0516"),
  cssColor("--brand-secondary-50", "Secondary 50", "palette", "#f7f2f2"),
  cssColor("--brand-secondary-100", "Secondary 100", "palette", "#ede0e0"),
  cssColor("--brand-secondary-200", "Secondary 200", "palette", "#ddc5c6"),
  cssColor("--brand-secondary-300", "Secondary 300", "palette", "#c9a1a3"),
  cssColor("--brand-secondary-400", "Secondary 400", "palette", "#a7676a"),
  cssColor("--brand-secondary-500", "Secondary 500", "palette", "#7e1f24"),
  cssColor("--brand-secondary-600", "Secondary 600", "palette", "#6f1b20"),
  cssColor("--brand-secondary-700", "Secondary 700", "palette", "#5d171b"),
  cssColor("--brand-secondary-800", "Secondary 800", "palette", "#491215"),
  cssColor("--brand-secondary-900", "Secondary 900", "palette", "#300c0e"),
  cssColor("--brand-secondary-950", "Secondary 950", "palette", "#1c0708"),
  cssColor("--brand-accent-50", "Accent 50", "palette", "#f1f9f3"),
  cssColor("--brand-accent-100", "Accent 100", "palette", "#dff1e4"),
  cssColor("--brand-accent-200", "Accent 200", "palette", "#c4e5cc"),
  cssColor("--brand-accent-300", "Accent 300", "palette", "#a0d5ad"),
  cssColor("--brand-accent-400", "Accent 400", "palette", "#65bc7a"),
  cssColor("--brand-accent-500", "Accent 500", "palette", "#1c9c3b"),
  cssColor("--brand-accent-600", "Accent 600", "palette", "#198934"),
  cssColor("--brand-accent-700", "Accent 700", "palette", "#15732c"),
  cssColor("--brand-accent-800", "Accent 800", "palette", "#105a22"),
  cssColor("--brand-accent-900", "Accent 900", "palette", "#0b3b16"),
  cssColor("--brand-accent-950", "Accent 950", "palette", "#06220d"),
  cssColor("--brand-highlight-50", "Highlight 50", "palette", "#f8fcfc"),
  cssColor("--brand-highlight-100", "Highlight 100", "palette", "#eef8f8"),
  cssColor("--brand-highlight-200", "Highlight 200", "palette", "#dff2f1"),
  cssColor("--brand-highlight-300", "Highlight 300", "palette", "#cbeae9"),
  cssColor("--brand-highlight-400", "Highlight 400", "palette", "#abdedb"),
  cssColor("--brand-highlight-500", "Highlight 500", "palette", "#83ceca"),
  cssColor("--brand-highlight-600", "Highlight 600", "palette", "#73b5b2"),
  cssColor("--brand-highlight-700", "Highlight 700", "palette", "#619895"),
  cssColor("--brand-highlight-800", "Highlight 800", "palette", "#4c7775"),
  cssColor("--brand-highlight-900", "Highlight 900", "palette", "#324e4d"),
  cssColor("--brand-highlight-950", "Highlight 950", "palette", "#1d2d2c"),
  cssColor("--neutral-50", "Neutral 50", "palette", "#fbf8fa"),
  cssColor("--neutral-100", "Neutral 100", "palette", "#f5edf3"),
  cssColor("--neutral-200", "Neutral 200", "palette", "#eadae6"),
  cssColor("--neutral-300", "Neutral 300", "palette", "#dbbed4"),
  cssColor("--neutral-400", "Neutral 400", "palette", "#c699bb"),
  cssColor("--neutral-500", "Neutral 500", "palette", "#483659"),
  cssColor("--neutral-600", "Neutral 600", "palette", "#342541"),
  cssColor("--neutral-700", "Neutral 700", "palette", "#241832"),
  cssColor("--neutral-800", "Neutral 800", "palette", "#1c1731"),
  cssColor("--neutral-900", "Neutral 900", "palette", "#140c1a"),
  cssColor("--neutral-950", "Neutral 950", "palette", "#09050d"),
  cssColor("--white", "White", "palette", "#ffffff"),
  cssColor("--ink-950", "Ink 950", "palette", "#08050c"),
  cssColor("--ink-800", "Ink 800", "palette", "#1c1731"),
  cssColor("--ink-600", "Ink 600", "palette", "#342541"),
  cssColor("--ink-500", "Ink 500", "palette", "#483659"),
  cssColor("--mist-100", "Mist 100", "palette", "#faf6f9"),
  cssColor("--mist-200", "Mist 200", "palette", "#f5edf3"),
  cssColor("--mist-300", "Mist 300", "palette", "#eadae6"),
  cssColor("--green-600", "Green 600", "palette", "#6e1558"),
  cssColor("--green-700", "Green 700", "palette", "#5d124a"),
  cssColor("--green-100", "Green 100", "palette", "#eddfe9"),
  cssColor("--blue-600", "Blue 600", "palette", "#6f1b20"),
  cssColor("--blue-100", "Blue 100", "palette", "#ede0e0"),
  cssColor("--amber-500", "Amber 500", "palette", "#ca7a0a"),
  cssText("--color-bg", "Page background", "semantic-color", "#fbf8fa"),
  cssText("--color-surface", "Surface", "semantic-color", "#faf6f9"),
  cssText("--color-surface-raised", "Raised surface", "semantic-color", "#ffffff"),
  cssText("--color-surface-strong", "Strong surface", "semantic-color", "#f5edf3"),
  cssText("--color-text", "Text", "semantic-color", "#08050c"),
  cssText("--color-muted", "Muted text", "semantic-color", "#342541"),
  cssText("--color-border", "Border", "semantic-color", "#eadae6"),
  cssText("--color-accent", "Accent", "semantic-color", "#6e1558"),
  cssText("--color-accent-hover", "Accent hover", "semantic-color", "#5d124a"),
  cssText("--color-accent-soft", "Soft accent", "semantic-color", "#eddfe9"),
  cssText("--color-accent-border", "Accent border", "semantic-color", "rgba(125, 24, 100, 0.32)"),
  cssText("--color-blue", "Blue", "semantic-color", "#6f1b20"),
  cssText("--color-blue-soft", "Soft blue", "semantic-color", "#ede0e0"),
  cssText("--color-on-accent", "On accent", "semantic-color", "#ffffff"),
  cssText("--color-highlight", "Highlight", "semantic-color", "#abdedb"),
  cssText("--color-highlight-soft", "Soft highlight", "semantic-color", "#eef8f8"),
  cssText("--color-on-highlight", "On highlight", "semantic-color", "#111416"),
  cssText("--color-warning", "Warning", "semantic-color", "var(--amber-500)"),
  cssText("--color-success", "Success", "semantic-color", "#1e984c"),
  cssText("--color-error", "Error", "semantic-color", "#cd2f28"),
  cssText("--color-info", "Info", "semantic-color", "#2c5de0"),
  cssText("--button-primary-bg", "Primary button background", "semantic-color", "#6e1558"),
  cssText("--button-primary-hover", "Primary button hover", "semantic-color", "#5d124a"),
  cssText("--button-primary-text", "Primary button text", "semantic-color", "#ffffff"),
  cssText("--button-secondary-bg", "Secondary button background", "semantic-color", "#f7f2f2"),
  cssText("--button-secondary-hover", "Secondary button hover", "semantic-color", "#ede0e0"),
  cssText("--button-secondary-text", "Secondary button text", "semantic-color", "#491215"),
  cssText("--button-secondary-border", "Secondary button border", "semantic-color", "#ddc5c6"),
  cssText("--link-color", "Link", "semantic-color", "#5d124a"),
  cssText("--link-hover", "Link hover", "semantic-color", "#490e3a"),
  cssText("--focus-ring", "Focus ring", "semantic-color", "#a76296"),
  cssText("--gradient-hero-start", "Hero gradient start", "semantic-color", "#6e1558"),
  cssText("--gradient-hero-end", "Hero gradient end", "semantic-color", "#7e1f24"),
  cssText("--gradient-hero-accent", "Hero gradient accent", "semantic-color", "#198934"),
  cssColor("--chart-1", "Chart 1", "palette", "#6e1558"),
  cssColor("--chart-2", "Chart 2", "palette", "#6f1b20"),
  cssColor("--chart-3", "Chart 3", "palette", "#198934"),
  cssColor("--chart-4", "Chart 4", "palette", "#83ceca"),
  cssText("--badge-brand-bg", "Brand badge background", "semantic-color", "#eddfe9"),
  cssText("--badge-brand-text", "Brand badge text", "semantic-color", "#5d124a"),
  cssText("--badge-brand-border", "Brand badge border", "semantic-color", "#ddc3d7"),
  cssText("--badge-highlight-bg", "Highlight badge background", "semantic-color", "#eef8f8"),
  cssText("--badge-highlight-text", "Highlight badge text", "semantic-color", "#4c7775"),
  cssText("--badge-highlight-border", "Highlight badge border", "semantic-color", "#dff2f1"),
  cssText("--dark-color-bg", "Dark page background", "semantic-color", "#09050d"),
  cssText("--dark-color-surface", "Dark surface", "semantic-color", "#120613"),
  cssText("--dark-color-text", "Dark text", "semantic-color", "#fbf8fa"),
  cssText("--dark-color-border", "Dark border", "semantic-color", "rgba(200, 158, 190, 0.22)"),
  cssText("--color-nav-bg", "Navigation background", "semantic-color", "rgba(255, 255, 255, 0.9)"),
  cssText("--color-footer-muted", "Footer muted text", "semantic-color", "rgba(251, 248, 250, 0.76)"),
  ...
  cssText("--section-padding-x", "Section horizontal padding", "layout", "clamp(1.25rem, 2.88vw, 2.16rem)"),
  cssText("--section-padding-y-sm", "Small section padding", "layout", "2.34rem"),
  cssText("--section-padding-y-md", "Medium section padding", "layout", "3.9rem"),
  cssText("--section-padding-y-lg", "Large section padding", "layout", "4.68rem"),
  cssNumber("--section-hero-min-height", "Hero section min height", "layout", 62, {
    min: 40,
    max: 100,
    step: 1,
    unit: "svh",
  ...
  cssNumber("--container-sm", "Small container", "layout", 810, containerRange),
  cssNumber("--container-md", "Medium container", "layout", 1076, containerRange),
  cssNumber("--container-lg", "Large container", "layout", 1328, containerRange),
  cssNumber("--container-xl", "Extra large container", "layout", 1575, containerRange),
  cssText("--content-readable-max", "Readable content max", "layout", "29rem"),
  cssText(
  ...
  cssNumber("--hero-grid-text-fr", "Hero grid text fraction", "layout", 1.06, fractionRange),
  cssNumber("--hero-grid-visual-fr", "Hero grid visual fraction", "layout", 0.94, fractionRange),
  cssNumber("--hero-grid-visual-min", "Hero visual min width", "layout", 22, componentRemRange),
  cssNumber("--hero-headline-max-width", "Hero headline max width", "layout", 62, {
    min: 24,
    max: 72,
    step: 1,
    unit: "rem",
  }),
  cssNumber("--hero-copy-max-width", "Hero copy max width", "layout", 62, {
    min: 24,
    max: 72,
    step: 1,
    unit: "rem",
  ...
  cssNumber("--button-font-size", "Button font size", "component-size", 0.8729, fontRemRange),
  cssNumber("--button-font-weight", "Button font weight", "component-size", 730, fontWeightRange),
  ...
  cssNumber("--badge-font-weight", "Badge font weight", "component-size", 730, fontWeightRange),
  cssText("--card-padding", "Card padding", "component-size", "1.17rem"),
  cssNumber("--lockup-logo-size", "Lockup logo size", "component-size", 27, lockupPxRange),
  cssText(
    "--lockup-wordmark-font",
    "Lockup wordmark font",
    "component-size",
    "Karla, Inter, ui-sans-serif, system-ui, sans-serif",
  ),
  cssNumber("--lockup-wordmark-size", "Lockup wordmark size", "component-size", 19, lockupPxRange),
  cssNumber("--lockup-wordmark-tracking", "Lockup wordmark tracking", "component-size", 0.2, {
    min: -2,
    max: 10,
    step: 0.1,
    unit: "px",
  }),
  cssNumber("--lockup-gap", "Lockup gap", "component-size", 10, lockupPxRange),
  cssNumber("--navbar-min-height", "Navbar min height", "component-size", 4.25, componentRemRange),
  cssNumber("--navbar-link-font-size", "Navbar link font size", "component-size", 0.8729, fontRemRange),
  cssText(
  ...
  cssNumber("--demo-canvas-left-fr", "Demo canvas left fraction", "component-size", 0.96, fractionRange),
  cssNumber("--demo-canvas-min-column", "Demo canvas min column", "component-size", 16, componentRemRange),
  cssNumber("--demo-canvas-right-fr", "Demo canvas right fraction", "component-size", 1.04, fractionRange),
  cssNumber("--demo-layer-font-size", "Demo layer font size", "component-size", 0.8729, fontRemRange),
  ...
  cssNumber("--faq-trigger-min-height", "FAQ trigger min height", "component-size", 3.51, componentRemRange),
  cssNumber("--radius-sm", "Small radius", "radii", 10, radiusRange),
  cssNumber("--radius-md", "Medium radius", "radii", 15, radiusRange),
  cssNumber("--radius-lg", "Large radius", "radii", 20, radiusRange),
  ...
  cssText("--shadow-soft", "Soft shadow", "elevation", "0 20px 60px rgba(9, 5, 13, 0.08)"),
  cssText("--shadow-raised", "Raised shadow", "elevation", "0 32px 100px rgba(9, 5, 13, 0.12)"),
  cssText("--shadow-brand", "Brand shadow", "elevation", "0 28px 84px rgba(110, 21, 88, 0.18)"),
  ...
  cssText(
    "--font-family-heading",
    "Heading font family",
    "typography", "Outfit, Inter, ui-sans-serif, system-ui, sans-serif",
  ),
  cssText(
    "--font-family-body",
    "Body font family",
  ...
  cssNumber("--font-size-display", "Display font size", "typography", 6.2947, fontRemRange),
  cssNumber("--font-size-h1", "H1 font size", "typography", 3.8951, fontRemRange),
  cssNumber("--font-size-h2", "H2 font size", "typography", 3.1029, fontRemRange),
  cssNumber("--font-size-h3", "H3 font size", "typography", 2.0907, fontRemRange),
  cssNumber("--font-size-h4", "H4 font size", "typography", 1.5205, fontRemRange),
  cssNumber("--font-size-body-lg", "Large body font size", "typography", 1.247, fontRemRange),
  cssNumber("--font-size-body", "Body font size", "typography", 0.9976, fontRemRange),
  cssNumber("--font-size-caption", "Caption font size", "typography", 0.7482, {
    ...fontRemRange,
    step: 0.001,
  }),
  cssNumber("--font-size-eyebrow", "Eyebrow font size", "typography", 0.6235, fontRemRange),
  cssNumber("--line-height-root", "Root line height", "typography", 1.497, lineHeightRange),
  cssNumber("--line-height-display", "Display line height", "typography", 0.992, lineHeightRange),
  cssNumber("--line-height-h1", "H1 line height", "typography", 1.033, lineHeightRange),
  cssNumber("--line-height-h2", "H2 line height", "typography", 1.067, lineHeightRange),
  cssNumber("--line-height-h3", "H3 line height", "typography", 1.145, lineHeightRange),
  cssNumber("--line-height-h4", "H4 line height", "typography", 1.327, lineHeightRange),
  cssNumber("--line-height-body-lg", "Large body line height", "typography", 1.595, lineHeightRange),
  cssNumber("--line-height-body", "Body line height", "typography", 1.496, lineHeightRange),
  cssNumber("--line-height-caption", "Caption line height", "typography", 1.498, lineHeightRange),
  cssNumber("--line-height-eyebrow", "Eyebrow line height", "typography", 1.598, lineHeightRange),
  cssNumber("--font-weight-heading", "Heading font weight", "typography", 790, fontWeightRange),
  cssNumber("--font-weight-body", "Body font weight", "typography", 410, fontWeightRange),
  cssNumber("--font-weight-strong", "Strong font weight", "typography", 830, fontWeightRange),
  cssNumber("--font-weight-label", "Label font weight", "typography", 770, fontWeightRange),
  cssNumber("--letter-spacing-heading", "Heading letter spacing", "typography", -0.012, {
    min: -0.1,
    max: 0.2,
    step: 0.001,
    unit: "em",
  }),
  cssNumber("--letter-spacing-eyebrow", "Eyebrow letter spacing", "typography", 0.002, {
    min: -0.1,
    max: 0.2,
    step: 0.001,
    unit: "em",
