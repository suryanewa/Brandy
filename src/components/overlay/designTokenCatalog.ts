...
export const DESIGN_TOKEN_CATALOG = [
  cssColor("--brand-primary-50", "Primary 50", "palette", "#fcf8fb"),
  cssColor("--brand-primary-100", "Primary 100", "palette", "#f8eef6"),
  cssColor("--brand-primary-200", "Primary 200", "palette", "#f2e0ef"),
  cssColor("--brand-primary-300", "Primary 300", "palette", "#eacde5"),
  cssColor("--brand-primary-400", "Primary 400", "palette", "#ddadd4"),
  cssColor("--brand-primary-500", "Primary 500", "palette", "#cd87c0"),
  cssColor("--brand-primary-600", "Primary 600", "palette", "#b477a9"),
  cssColor("--brand-primary-700", "Primary 700", "palette", "#98648e"),
  cssColor("--brand-primary-800", "Primary 800", "palette", "#774e6f"),
  cssColor("--brand-primary-900", "Primary 900", "palette", "#4e3349"),
  cssColor("--brand-primary-950", "Primary 950", "palette", "#2d1e2a"),
  cssColor("--brand-secondary-50", "Secondary 50", "palette", "#fcf8f9"),
  cssColor("--brand-secondary-100", "Secondary 100", "palette", "#f8eff2"),
  cssColor("--brand-secondary-200", "Secondary 200", "palette", "#f3e1e7"),
  cssColor("--brand-secondary-300", "Secondary 300", "palette", "#ebced8"),
  cssColor("--brand-secondary-400", "Secondary 400", "palette", "#dfb0bf"),
  cssColor("--brand-secondary-500", "Secondary 500", "palette", "#d08ba1"),
  cssColor("--brand-secondary-600", "Secondary 600", "palette", "#b77a8e"),
  cssColor("--brand-secondary-700", "Secondary 700", "palette", "#9a6777"),
  cssColor("--brand-secondary-800", "Secondary 800", "palette", "#79515d"),
  cssColor("--brand-secondary-900", "Secondary 900", "palette", "#4f353d"),
  cssColor("--brand-secondary-950", "Secondary 950", "palette", "#2e1f23"),
  cssColor("--brand-accent-50", "Accent 50", "palette", "#fbf7fc"),
  cssColor("--brand-accent-100", "Accent 100", "palette", "#f5edf8"),
  cssColor("--brand-accent-200", "Accent 200", "palette", "#eddef3"),
  cssColor("--brand-accent-300", "Accent 300", "palette", "#e1c9eb"),
  cssColor("--brand-accent-400", "Accent 400", "palette", "#cfa8de"),
  cssColor("--brand-accent-500", "Accent 500", "palette", "#b87fcf"),
  cssColor("--brand-accent-600", "Accent 600", "palette", "#a270b6"),
  cssColor("--brand-accent-700", "Accent 700", "palette", "#885e99"),
  cssColor("--brand-accent-800", "Accent 800", "palette", "#6b4a78"),
  cssColor("--brand-accent-900", "Accent 900", "palette", "#46304f"),
  cssColor("--brand-accent-950", "Accent 950", "palette", "#281c2e"),
  cssColor("--brand-highlight-50", "Highlight 50", "palette", "#fdfcfc"),
  cssColor("--brand-highlight-100", "Highlight 100", "palette", "#fbf9f8"),
  cssColor("--brand-highlight-200", "Highlight 200", "palette", "#f8f3f2"),
  cssColor("--brand-highlight-300", "Highlight 300", "palette", "#f3ecea"),
  cssColor("--brand-highlight-400", "Highlight 400", "palette", "#ece0de"),
  cssColor("--brand-highlight-500", "Highlight 500", "palette", "#e3d1ce"),
  cssColor("--brand-highlight-600", "Highlight 600", "palette", "#c8b8b5"),
  cssColor("--brand-highlight-700", "Highlight 700", "palette", "#a89b98"),
  cssColor("--brand-highlight-800", "Highlight 800", "palette", "#847977"),
  cssColor("--brand-highlight-900", "Highlight 900", "palette", "#564f4e"),
  cssColor("--brand-highlight-950", "Highlight 950", "palette", "#322e2d"),
  cssColor("--neutral-50", "Neutral 50", "palette", "#fefbfd"),
  cssColor("--neutral-100", "Neutral 100", "palette", "#fbf5fa"),
  cssColor("--neutral-200", "Neutral 200", "palette", "#f7ecf5"),
  cssColor("--neutral-300", "Neutral 300", "palette", "#f1dded"),
  cssColor("--neutral-400", "Neutral 400", "palette", "#e9cae3"),
  cssColor("--neutral-500", "Neutral 500", "palette", "#5e5573"),
  cssColor("--neutral-600", "Neutral 600", "palette", "#453e55"),
  cssColor("--neutral-700", "Neutral 700", "palette", "#332c43"),
  cssColor("--neutral-800", "Neutral 800", "palette", "#26243c"),
  cssColor("--neutral-900", "Neutral 900", "palette", "#1c1723"),
  cssColor("--neutral-950", "Neutral 950", "palette", "#0e0c12"),
  cssColor("--white", "White", "palette", "#ffffff"),
  cssColor("--ink-950", "Ink 950", "palette", "#0d0b11"),
  cssColor("--ink-800", "Ink 800", "palette", "#26243c"),
  cssColor("--ink-600", "Ink 600", "palette", "#453e55"),
  cssColor("--ink-500", "Ink 500", "palette", "#5e5573"),
  cssColor("--mist-100", "Mist 100", "palette", "#fdfafc"),
  cssColor("--mist-200", "Mist 200", "palette", "#fbf5fa"),
  cssColor("--mist-300", "Mist 300", "palette", "#f7ecf5"),
  cssColor("--green-600", "Green 600", "palette", "#b477a9"),
  cssColor("--green-700", "Green 700", "palette", "#98648e"),
  cssColor("--green-100", "Green 100", "palette", "#f8eef6"),
  cssColor("--blue-600", "Blue 600", "palette", "#b77a8e"),
  cssColor("--blue-100", "Blue 100", "palette", "#f8eff2"),
  cssColor("--amber-500", "Amber 500", "palette", "#d67816"),
  cssText("--color-bg", "Page background", "semantic-color", "#fefbfd"),
  cssText("--color-surface", "Surface", "semantic-color", "#fdfafc"),
  cssText("--color-surface-raised", "Raised surface", "semantic-color", "#ffffff"),
  cssText("--color-surface-strong", "Strong surface", "semantic-color", "#fbf5fa"),
  cssText("--color-text", "Text", "semantic-color", "#0d0b11"),
  cssText("--color-muted", "Muted text", "semantic-color", "#453e55"),
  cssText("--color-border", "Border", "semantic-color", "#f7ecf5"),
  cssText("--color-accent", "Accent", "semantic-color", "#b477a9"),
  cssText("--color-accent-hover", "Accent hover", "semantic-color", "#98648e"),
  cssText("--color-accent-soft", "Soft accent", "semantic-color", "#f8eef6"),
  cssText("--color-accent-border", "Accent border", "semantic-color", "rgba(205, 135, 192, 0.32)"),
  cssText("--color-blue", "Blue", "semantic-color", "#b77a8e"),
  cssText("--color-blue-soft", "Soft blue", "semantic-color", "#f8eff2"),
  cssText("--color-on-accent", "On accent", "semantic-color", "#111416"),
  cssText("--color-highlight", "Highlight", "semantic-color", "#ece0de"),
  cssText("--color-highlight-soft", "Soft highlight", "semantic-color", "#fbf9f8"),
  cssText("--color-on-highlight", "On highlight", "semantic-color", "#111416"),
  cssText("--color-warning", "Warning", "semantic-color", "var(--amber-500)"),
  cssText("--color-success", "Success", "semantic-color", "#25a153"),
  cssText("--color-error", "Error", "semantic-color", "#d92d34"),
  cssText("--color-info", "Info", "semantic-color", "#3266e8"),
  cssText("--button-primary-bg", "Primary button background", "semantic-color", "#b477a9"),
  cssText("--button-primary-hover", "Primary button hover", "semantic-color", "#98648e"),
  cssText("--button-primary-text", "Primary button text", "semantic-color", "#111416"),
  cssText("--button-secondary-bg", "Secondary button background", "semantic-color", "#fcf8f9"),
  cssText("--button-secondary-hover", "Secondary button hover", "semantic-color", "#f8eff2"),
  cssText("--button-secondary-text", "Secondary button text", "semantic-color", "#79515d"),
  cssText("--button-secondary-border", "Secondary button border", "semantic-color", "#f3e1e7"),
  cssText("--link-color", "Link", "semantic-color", "#111416"),
  cssText("--link-hover", "Link hover", "semantic-color", "#774e6f"),
  cssText("--focus-ring", "Focus ring", "semantic-color", "#ddadd4"),
  cssText("--gradient-hero-start", "Hero gradient start", "semantic-color", "#b477a9"),
  cssText("--gradient-hero-end", "Hero gradient end", "semantic-color", "#d08ba1"),
  cssText("--gradient-hero-accent", "Hero gradient accent", "semantic-color", "#a270b6"),
  cssColor("--chart-1", "Chart 1", "palette", "#b477a9"),
  cssColor("--chart-2", "Chart 2", "palette", "#b77a8e"),
  cssColor("--chart-3", "Chart 3", "palette", "#a270b6"),
  cssColor("--chart-4", "Chart 4", "palette", "#e3d1ce"),
  cssText("--badge-brand-bg", "Brand badge background", "semantic-color", "#f8eef6"),
  cssText("--badge-brand-text", "Brand badge text", "semantic-color", "#98648e"),
  cssText("--badge-brand-border", "Brand badge border", "semantic-color", "#f2e0ef"),
  cssText("--badge-highlight-bg", "Highlight badge background", "semantic-color", "#fbf9f8"),
  cssText("--badge-highlight-text", "Highlight badge text", "semantic-color", "#111416"),
  cssText("--badge-highlight-border", "Highlight badge border", "semantic-color", "#f8f3f2"),
  cssText("--dark-color-bg", "Dark page background", "semantic-color", "#0e0c12"),
  cssText("--dark-color-surface", "Dark surface", "semantic-color", "#1d151f"),
  cssText("--dark-color-text", "Dark text", "semantic-color", "#fefbfd"),
  cssText("--dark-color-border", "Dark border", "semantic-color", "rgba(234, 205, 229, 0.22)"),
  cssText("--color-nav-bg", "Navigation background", "semantic-color", "rgba(255, 255, 255, 0.9)"),
  cssText("--color-footer-muted", "Footer muted text", "semantic-color", "rgba(254, 251, 253, 0.76)"),
  ...
  cssText("--section-padding-y-sm", "Small section padding", "layout", "1.89rem"),
  cssText("--section-padding-y-md", "Medium section padding", "layout", "3.15rem"),
  cssText("--section-padding-y-lg", "Large section padding", "layout", "3.78rem"),
  ...
  cssNumber("--hero-grid-text-fr", "Hero grid text fraction", "layout", 1.1, fractionRange),
  cssNumber("--hero-grid-visual-fr", "Hero grid visual fraction", "layout", 0.9, fractionRange),
  cssNumber("--hero-grid-visual-min", "Hero visual min width", "layout", 22, componentRemRange),
  cssNumber("--hero-headline-max-width", "Hero headline max width", "layout", 16, {
    min: 4,
    max: 24,
    step: 1,
    unit: "ch",
  }),
  cssNumber("--hero-copy-max-width", "Hero copy max width", "layout", 16, {
    min: 4,
    max: 24,
    step: 1,
    unit: "ch",
  }),
  cssNumber("--hero-description-max-width", "Hero description max width", "layout", 31, contentRemRange),
  ...
  cssNumber("--button-font-size", "Button font size", "component-size", 0.882, fontRemRange),
  ...
  cssText("--card-padding", "Card padding", "component-size", "0.95rem"),
  cssNumber("--lockup-logo-size", "Lockup logo size", "component-size", 37, lockupPxRange),
  cssText(
    "--lockup-wordmark-font",
    "Lockup wordmark font",
    "component-size",
    "\"Archivo Black\", Archivo, Inter, ui-sans-serif, system-ui, sans-serif",
  ),
  cssNumber("--lockup-wordmark-size", "Lockup wordmark size", "component-size", 15, lockupPxRange),
  cssNumber("--lockup-wordmark-tracking", "Lockup wordmark tracking", "component-size", 3, {
    min: -2,
    max: 10,
    step: 0.1,
    unit: "px",
  }),
  cssNumber("--lockup-gap", "Lockup gap", "component-size", 8, lockupPxRange),
  cssNumber("--navbar-min-height", "Navbar min height", "component-size", 4.25, componentRemRange),
  cssNumber("--navbar-link-font-size", "Navbar link font size", "component-size", 0.882, fontRemRange),
  cssText(
  ...
  cssNumber("--demo-canvas-left-fr", "Demo canvas left fraction", "component-size", 0.93, fractionRange),
  cssNumber("--demo-canvas-min-column", "Demo canvas min column", "component-size", 16, componentRemRange),
  cssNumber("--demo-canvas-right-fr", "Demo canvas right fraction", "component-size", 1.07, fractionRange),
  cssNumber("--demo-layer-font-size", "Demo layer font size", "component-size", 0.882, fontRemRange),
  ...
  cssNumber("--faq-trigger-min-height", "FAQ trigger min height", "component-size", 2.83, componentRemRange),
  cssNumber("--radius-sm", "Small radius", "radii", 2, radiusRange),
  cssNumber("--radius-md", "Medium radius", "radii", 3, radiusRange),
  cssNumber("--radius-lg", "Large radius", "radii", 4, radiusRange),
  ...
  cssText("--shadow-soft", "Soft shadow", "elevation", "0 20px 60px rgba(14, 12, 18, 0.08)"),
  cssText("--shadow-raised", "Raised shadow", "elevation", "0 32px 100px rgba(14, 12, 18, 0.12)"),
  cssText("--shadow-brand", "Brand shadow", "elevation", "0 28px 84px rgba(180, 119, 169, 0.18)"),
  ...
  cssText(
    "--font-family-heading",
    "Heading font family",
    "typography", "Manrope, Inter, ui-sans-serif, system-ui, sans-serif",
  ),
  cssText(
    "--font-family-body",
    "Body font family",
  ...
  cssNumber("--font-size-display", "Display font size", "typography", 5.7217, fontRemRange),
  cssNumber("--font-size-h1", "H1 font size", "typography", 3.5969, fontRemRange),
  cssNumber("--font-size-h2", "H2 font size", "typography", 2.8653, fontRemRange),
  cssNumber("--font-size-h3", "H3 font size", "typography", 2.0343, fontRemRange),
  cssNumber("--font-size-h4", "H4 font size", "typography", 1.4795, fontRemRange),
  cssNumber("--font-size-body-lg", "Large body font size", "typography", 1.26, fontRemRange),
  cssNumber("--font-size-body", "Body font size", "typography", 1.008, fontRemRange),
  cssNumber("--font-size-caption", "Caption font size", "typography", 0.756, {
    ...fontRemRange,
    step: 0.001,
  }),
  cssNumber("--font-size-eyebrow", "Eyebrow font size", "typography", 0.63, fontRemRange),
  cssNumber("--line-height-root", "Root line height", "typography", 1.51, lineHeightRange),
  cssNumber("--line-height-display", "Display line height", "typography", 1.066, lineHeightRange),
  cssNumber("--line-height-h1", "H1 line height", "typography", 1.083, lineHeightRange),
  cssNumber("--line-height-h2", "H2 line height", "typography", 1.105, lineHeightRange),
  cssNumber("--line-height-h3", "H3 line height", "typography", 1.166, lineHeightRange),
  cssNumber("--line-height-h4", "H4 line height", "typography", 1.34, lineHeightRange),
  cssNumber("--line-height-body-lg", "Large body line height", "typography", 1.616, lineHeightRange),
  cssNumber("--line-height-body", "Body line height", "typography", 1.514, lineHeightRange),
  cssNumber("--line-height-caption", "Caption line height", "typography", 1.508, lineHeightRange),
  cssNumber("--line-height-eyebrow", "Eyebrow line height", "typography", 1.608, lineHeightRange),
  ...
  cssNumber("--letter-spacing-heading", "Heading letter spacing", "typography", 0.027, {
    min: -0.1,
    max: 0.2,
    step: 0.001,
    unit: "em",
